...
def _post_lead_to_nopaperforms(
    *,
    ...
    payload = {
        ...
        "cf_form_name": "Microsite - EdTech Launchpad Program",
        "cf_program": "EdTech Launchpad Program",
...
def _post_brochure_lead_to_nopaperforms(
    *,
    ...
    payload = {
        ...
        "medium": _str_utm(utm_medium),
        "campaign": _str_utm(utm_campaign),
        "cf_form_name": "Brochure - EdTech Launchpad Program",
        "cf_program": "EdTech Launchpad Program",
        "cf_pg_program": "PG Program",
        "cf_batch_name": "Select Batch Name",
    }
