...
const STEPS = [
  ...
  {
    number: "02",
    title: "AI and Leader Interview Round",
    description:
      "Candidates first complete an AI Interview, followed by an online interview with the leadership team during the available time slots.",
  },
  {
    number: "03",
    title: "Training Program",
    description:
      "Selected candidates undergo 2 weeks of online classroom training focused on CASA sales and banking fundamentals.",
  },
  {
    number: "04",
    title: "Final Interview",
    description:
      "After training, candidates appear for a direct interview with a top bank.",
  },
  {
    number: "05",
      ...
      <div className="relative z-10 mx-auto px-section py-section lg:px-[120px] lg:py-20">
        ...
        <div className="mt-8 sm:mt-12 flex flex-col lg:flex-row gap-6 lg:gap-8">
          ...
          <div className="flex-1 flex justify-start min-w-0">
            <div
              className="overflow-hidden bg-black w-full max-w-none lg:max-w-[582px] h-[345px] sm:h-[460px] lg:h-[610px] p-0 sm:p-0 lg:p-6 lg:rounded-[10px] enrollment-image-mobile"
            >
              <img
                src={enrollmentImage}
              ...
              {STEPS.map((step) => (
                ...
                >
                  {(() => {
                    ...
                    const accentColor = "rgba(143, 40, 44, 1)";
