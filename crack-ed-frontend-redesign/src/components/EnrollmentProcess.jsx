...
const STEPS = [
  {
    ...
    description:
      "Complete your application and AI interview. Pay the Rs 2,500 registration fee to  proceed to the employer round.",
  },
  {
    number: "02",
    title: "Selection & Offer",
    description:
      "Upon selection, receive your Letter of Intent (LOI) from Cogent eServices before you start training.",
  },
  {
    number: "03",
    title: "Enrollment & Training",
    description:
      "Finalize your enrollment by paying the balance program fee to begin your 4-week professional classroom training and certification.",
  },
  {
    number: "04",
    title: "Proficiency Assessment",
    description:
      "Complete a communication test (Versant) during training to validate your skills, with a second attempt provided if required.",
  },
  {
    number: "05",
    title: "Onboarding",
    description:
      "Join Cogent eServices full-time upon clearing the test. If unsuccessful after two attempts, receive a refund or an alternate placement.",
  },
];
      ...
      <div className="relative z-10 mx-auto px-section py-section lg:px-[120px] lg:py-20">
        ...
        <div className="mt-8 sm:mt-12 flex flex-col lg:flex-row gap-6 lg:gap-8">
          ...
          <div className="flex-1 flex justify-start min-w-0">
            <div
              className="overflow-hidden bg-black w-full max-w-none lg:max-w-[582px] h-[345px] sm:h-[460px] lg:h-[640px] p-0 sm:p-0 lg:p-6 lg:rounded-[10px] enrollment-image-mobile"
            >
              <img
                src={enrollmentImage}
