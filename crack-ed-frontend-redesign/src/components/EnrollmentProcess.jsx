...
const STEPS = [
  ...
  },
  {
    ...
    description:
      "Successful candidates will be notified of their selection and will move forward to the fee payment stage.",
  },
  {
    number: "04",
  ...
  },
  {
    ...
    title: "Onboarding",
    description:
      "Transition into a full-time role as a Relationship Manager (Mortgage Sales) upon successful completion of the training.",
  },
];
