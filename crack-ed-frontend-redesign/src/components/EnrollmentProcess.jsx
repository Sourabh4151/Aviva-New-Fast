...
const STEPS = [
  {
    ...
    description:
      "Start your journey by filling out the online application form with your basic details.",
  },
  {
    number: "02",
    title: "Crack-ED Screening Interview",
    description:
      "Attend a screening interview to assess your communication skills, aptitude, and role readiness.",
  },
  {
    number: "03",
    title: "Kotak Mahindra Bank Interview",
    description:
      "Meet the hiring team and showcase your suitability for the Gold Loan Relationship Officer role.",
  },
  {
    number: "04",
    title: "Receive Your Enrolment Letter",
    description:
              ...
              {STEPS.map((step, index) => (
                ...
                >
                  {(() => {
                    ...
                    const accentColor = "rgba(228, 19, 37, 1)";
