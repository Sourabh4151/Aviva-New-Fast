      ...
      <div className="relative z-10 mx-auto px-section py-section lg:px-[120px] lg:py-20">
        ...
        <div className="mt-8 sm:mt-12 flex flex-col lg:flex-row gap-6 lg:gap-8">
          ...
          <div className="flex-1 flex justify-start min-w-0">
            <div
              className="overflow-hidden bg-black w-full max-w-none lg:max-w-[582px] h-[400px] sm:h-[540px] lg:h-[555px] p-0 sm:p-0 lg:p-6 lg:rounded-[10px] enrollment-image-mobile"
            >
              <img
                src={enrollmentImage}
              ...
              {STEPS.map((step) => (
                ...
                >
                  {(() => {
                    ...
                    const accentColor = "rgba(3, 149, 218, 1)";
