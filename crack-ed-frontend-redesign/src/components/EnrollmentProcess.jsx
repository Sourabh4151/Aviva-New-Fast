...
const STEPS = [
  ...
  {
    number: "02",
    title: "Counselling & AI Interview",
    description:
      "Complete a guided counselling session and qualify through an AI-based interview.",
  },
  {
    number: "03",
    title: "Employer Interview & LOI",
    description:
      "Attend a 1-round interview with a top bank and receive your LOI upon selection.",
  },
  {
    number: "04",
    title: "Classroom Training",
    description:
      "Undergo 3 weeks of immersive, instructor-led offline training.",
  },
  {
    number: "05",
    title: "Full-Time Employment",
    description:
      "Start your full-time role after successfully completing the training program.",
  },
];
