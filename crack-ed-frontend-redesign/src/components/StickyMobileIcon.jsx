  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end gap-3">
        ...
        >
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <button
              ...
              className="w-full rounded-xl cursor-pointer transition-all duration-200 bg-[rgba(239,59,36,1)] hover:bg-[rgba(239,59,36,0.8)] hover:scale-[1.02] active:scale-[0.98]"
              style={{
                fontFamily: "Montserrat, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif",
                fontWeight: 600,
                fontSize: "14px",
      ...
      <button
        ...
        style={{
          background: "linear-gradient(135deg, rgba(239, 59, 36, 1) 0%, rgba(239, 59, 36, 0.8) 100%)",
          boxShadow: "0 8px 32px rgba(239, 59, 36, 0.3), 0 4px 16px rgba(0, 0, 0, 0.3)",
        }}
        aria-label={isOpen ? "Close talk to us" : "Open talk to us"}
      >
        {/* Pulse ring animation */}
        <span className="absolute inset-0 rounded-full animate-ping opacity-20 bg-[rgba(239,59,36,1)]" />
