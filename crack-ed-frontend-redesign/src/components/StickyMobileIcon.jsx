  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end gap-3">
      ...
      <button
        ...
        style={{
          background: "linear-gradient(135deg, rgba(228, 19, 37, 1) 0%, rgba(228, 19, 37, 1) 100%)",
          boxShadow: "0 8px 32px rgba(228, 19, 37, 0.3), 0 4px 16px rgba(0, 0, 0, 0.3)",
        }}
        aria-label={isOpen ? "Close talk to us" : "Open talk to us"}
      >
        {/* Pulse ring animation */}
        <span className="absolute inset-0 rounded-full animate-ping opacity-20 bg-[rgba(228, 19, 37, 1)]" />
