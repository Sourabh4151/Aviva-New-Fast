  ...
  return (
    ...
    >
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <button
              ...
              style={{
                ...
                color: "rgba(250, 250, 250, 1)",
                padding: "14px 24px",
                backgroundColor: "rgba(159,17,38,1)",
              }}
            >
      ...
      <button
        ...
        style={{
          background: "rgba(159,17,38,1)",
          boxShadow: "0 8px 32px rgba(159,17,38,0.3), 0 4px 16px rgba(0, 0, 0, 0.3)",
        }}
        aria-label={isOpen ? "Close talk to us" : "Open talk to us"}
      >
        {/* Pulse ring animation */}
        <span className="absolute inset-0 rounded-full animate-ping opacity-20 bg-[rgba(159,17,38,1)]" />
