    ...
    >
        ...
        >
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <button
              ...
              className="w-full rounded-[10px] cursor-pointer transition-all duration-200 hover:bg-white/[0.08] active:bg-white/[0.12]"
              style={{
                fontFamily: "Montserrat, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif",
                fontWeight: 600,
                fontSize: "14px",
      ...
      <button
        ...
        style={{
          backgroundColor: "rgba(13, 11, 0, 1)",
          border: "1px solid rgba(250, 250, 250, 1)",
          boxShadow: "0 8px 32px rgba(0, 0, 0, 0.45), 0 4px 16px rgba(0, 0, 0, 0.3)",
        }}
        aria-label={isOpen ? "Close talk to us" : "Open talk to us"}
      >
        {/* Pulse ring animation */}
        <span className="absolute inset-0 rounded-full animate-ping opacity-20 bg-[rgba(250,250,250,1)]" />
