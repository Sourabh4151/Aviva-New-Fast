    ...
    >
      ...
      <button
        ...
        style={{
          ...
          boxShadow: "0 8px 32px rgba(10, 49, 82, 0.3), 0 4px 16px rgba(0, 0, 0, 0.3)",
        }}
        aria-label={isOpen ? "Close talk to us" : "Open talk to us"}
      >
        {/* Pulse ring animation */}
        <span className="absolute inset-0 rounded-full animate-ping opacity-20 bg-[rgba(239, 65, 35, 1)]" />
