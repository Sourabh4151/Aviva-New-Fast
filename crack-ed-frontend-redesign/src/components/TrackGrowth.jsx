...
const ITEMS = [
  {
    key: "alignment",
    icon: alignmentIcon,
    title: "Dedicated Founder Mentor",
    description:
      "Get matched with a sector-aligned mentor from Day 1 and receive 7 hours of one-on-one mentoring throughout the fellowship.",
  },
  {
    key: "progress",
    icon: progressIcon,
    title: "Founder-Led Case Studies",
    description:
      "Learn directly from successful entrepreneurs through 10 founder-led case study sessions.",
  },
  {
    key: "review",
    icon: reviewIcon,
    ...
    description:
      "Join monthly fireside conversations and cohort mentoring sessions with accomplished entrepreneurs.",
  },
];
    ...
    >
      <div className="relative z-10 mx-auto px-section py-section lg:px-[120px] lg:py-20">
        ...
        <div className="max-w-4xl flex flex-col items-start text-left sm:items-center sm:text-center mx-auto">
          ...
          >
            Founder Access, Not Just Faculty Access
          </p>
        </div>
