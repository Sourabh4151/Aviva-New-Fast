...
const REQUIREMENTS = [
  "Graduates looking to build a career in Consumer Finance & Sales",
  "Should be 28 years of age or younger",
          ...
          <div className="flex-1 flex justify-start lg:justify-end w-full lg:w-auto lg:-ml-10">
            <div className="relative w-full max-w-[364px] sm:max-w-[422px]">
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle at 0% 50%, rgba(10, 49, 82, 1) 0, transparent 60%), radial-gradient(circle at 100% 50%, rgba(10, 49, 82, 1) 0, transparent 60%), radial-gradient(circle at 50% 0%, rgba(10, 49, 82, 1) 0, transparent 60%), radial-gradient(circle at 50% 100%, rgba(10, 49, 82, 1) 0, transparent 60%)",
                  filter: "blur(32px)",
                  opacity: 1,
                }}
              />
