...
const REQUIREMENTS = [
  ...
  "Requires a minimum of 1–3 years of hands-on experience in debt collections and financial recovery roles.",
  "Must have a basic understanding of the SARFAESI Act and standard recovery processes.",
];
          ...
          <div className="flex-1 flex justify-start lg:justify-end w-full lg:w-auto lg:-ml-10">
            <div className="relative w-full max-w-[364px] sm:max-w-[422px]">
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle at 50% 50%, rgba(58, 45, 125, 0.7) 0, rgba(58, 45, 125, 0.0) 65%)",
                  filter: "blur(35px)",
                  opacity: 1,
                }}
              />
