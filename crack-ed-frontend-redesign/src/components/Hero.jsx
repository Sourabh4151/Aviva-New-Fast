...
export default function Hero() {
  ...
  const brochurePdfPath = "/PGC - BANKING MANAGEMENT.pdf";
  const brochurePdfHref = encodeURI(brochurePdfPath);
  const brochurePdfDownloadName = "PGC - BANKING MANAGEMENT.pdf";
    ...
    try {
      ...
      if (res.ok) {
        ...
        trackPixelEvent("CompleteRegistration", {
          content_name: "PGC - BANKING MANAGEMENT",
  ...
  return (
    <section id="hero" className="relative max-lg:bg-black">
      ...
      <div
        className="w-full min-h-[670px] sm:min-h-[710px] lg:h-[690px] bg-cover bg-no-repeat relative max-lg:bg-[20%_60%] lg:bg-[center_90%]"
      ...
      >
        ...
        >
          ...
          <div className="hero-container relative">
            <div className="absolute left-[120px] top-[155px] lg:top-[250px] w-[586px] max-w-[calc(100%-2rem)] text-white left-adjust hero-left-adjust">
              <h1
