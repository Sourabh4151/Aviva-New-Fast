...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative max-lg:flex max-lg:flex-col max-lg:bg-black">
      {/* Hero background: fixed height on desktop; on mobile the in-flow content grows the box so the form does not overlap the CTA. */}
      <div
        className="w-full relative overflow-hidden lg:h-[690px]"
        role="img"
        aria-label="EdTech Launchpad Program hero"
      >
        <div
          className="absolute inset-0 bg-cover bg-no-repeat max-lg:bg-[90%_center] lg:bg-center scale-x-[-1]"
                ...
                <div className="flex w-full min-w-0 flex-col items-start gap-[16px]">
                    ...
                    <h1
                      ...
                      style={{
                        ...
                        textShadow: "0 4px 4px rgba(0, 0, 0, 0.3), 0 8px 12px rgba(0, 0, 0, 0.15)",
                      }}
                    >
                      EdTech Launchpad Program
                    </h1>
                    <ul className="hero-bullet-list hero-frame-23 flex w-full max-w-[579px] flex-col gap-[8px] text-[rgba(250,250,250,1)]">
      ...
      >
          ...
          >
            ...
            <div ref={cityRef} className="relative">
              <div
                ...
                className={`custom-select w-full px-4 h-[50px] rounded-[10px] bg-transparent ${FORM_FIELD_BORDER} font-normal text-[14px] flex items-center justify-between gap-2 ${form.state ? "cursor-text" : "cursor-not-allowed opacity-60"
                  }`}
              >
                {form.state ? (
                  <input
        ...
        <div className={`flex flex-col items-center pt-4 ${alreadyInSystem ? "pb-6" : "pb-1"}`}>
          <button
            ...
            className="otp-btn disabled:cursor-not-allowed disabled:opacity-70"
