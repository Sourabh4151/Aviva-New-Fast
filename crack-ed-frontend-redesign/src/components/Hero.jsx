          ...
          <div className="hero-container relative">
            <div className="absolute left-[120px] max-w-[773px] text-white left-adjust hero-left-adjust">
              ...
              <div className="hero-heading-block">
                <h1 className="hero-title">Become a Crack-ED Partner</h1>
                <p className="hero-tagline">
                  Earn on every student admission. No upfront investment.
                </p>
              </div>
              <ul className="hero-bullet-list space-y-3">
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  <span className="hero-bullet-text">
                    Earn attractive payouts on every admission and unlock up to 12% in performance incentives.
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span className="hero-bullet-text">
                    Partner with job-linked programs that candidates are looking for.
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span className="hero-bullet-text">
                    Join a network of 10,000+ partners, where partners have earned up to Rs 1.17 lakh in a single month.
                  </span>
                </li>
              </ul>
            </div>
