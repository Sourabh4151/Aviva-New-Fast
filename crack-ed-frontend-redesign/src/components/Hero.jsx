      ...
      >
        ...
        >
          ...
          <div className="hero-container relative">
            <div className="absolute left-[120px] top-[155px] lg:top-[150px] w-[586px] max-w-[calc(100%-2rem)] text-white left-adjust hero-left-adjust">
              ...
              <h1
                className="hero-title w-[488px] max-w-full text-[48px] font-semibold leading-[100%] tracking-[0em] text-[rgba(250,250,250,1)] mb-4"
                style={{ fontFamily: "Montserrat, sans-serif" }}
              >
                Mapping Dreams to Smart Savings, One Plan at a Time 
              </h1>
              <ul className="hero-bullet-list text-gray-200 space-y-3 mb-8">
                ...
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    A dedicated 3-month path to help you transition into your new role with confidence.
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                   Ideal for graduates up to 30 years of age looking to launch a high-growth corporate career in life insurance sales.
                  </span>
                </li>
              </ul>
