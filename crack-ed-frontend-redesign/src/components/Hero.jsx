...
import rupyyLogo from "../assets/rupyy_logo.svg";
...
export default function Hero() {
  ...
  const brochurePdfPath = "/Rupyy AutoEdge Program.pdf";
  const brochurePdfHref = encodeURI(brochurePdfPath);
  const brochurePdfDownloadName = "Rupyy AutoEdge Program.pdf";
  ...
  async function handleSubmit(e) {
    ...
    if (!consentPaidProgram) {
      newErrors.consentPaidProgram = "कृपया पुष्टि करें कि आप प्रोग्राम की फ़ीस समझ गए हैं।";
    }
    if (!consentContact) {
      newErrors.consentContact = "कृपया इस प्रोग्राम के संबंध में संपर्क किए जाने के लिए सहमति दें।";
    }
    ...
    try {
      ...
      if (res.ok) {
        ...
        trackPixelEvent("CompleteRegistration", {
          content_name: "Mahindra Finance Prarambh Program",
  ...
  return (
    <section id="hero" className="relative max-lg:bg-black">
      ...
      <div
        className="w-full min-h-[730px] sm:min-h-[770px] lg:h-[690px] bg-cover bg-no-repeat relative max-lg:bg-[20%_center] lg:bg-center"
      ...
      >
        ...
        >
          ...
          <div className="hero-container relative">
            <div className="absolute left-[120px] top-[155px] lg:top-[230px] w-[586px] max-w-[calc(100%-2rem)] text-white left-adjust hero-left-adjust">
              <div className="hero-logo-badge mb-2 w-[161px] h-[69px] overflow-hidden">
                <img
                  src={rupyyLogo}
                  alt="Rupyy AutoEdge"
              ...
              <h1
                className="hero-title text-[40px] sm:text-[40px] md:text-[40px] lg:text-[48px] font-semibold leading-[120%] tracking-[0em] mb-4"
                style={{ fontFamily: "Montserrat, sans-serif" }}
              >
                हर सफर को दें नई उड़ान
              </h1>
              <ul className="hero-bullet-list text-gray-200 space-y-3 mb-8">
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  <span
                    className="hero-subtitle text-[16px] leading-[140%] font-normal tracking-[0em] text-[rgba(250,250,250,1)]"
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    यूज़्ड कार फाइनेंस में बिज़नेस मैनेजर बनें और पाएं ₹3 लाख वार्षिक वेतन (CTC) + आकर्षक इंसेंटिव।
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    नई नौकरी की शुरुआत आसान बनाने के लिए 1 महीने की विशेष ट्रेनिंग।
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    30 साल या उससे कम उम्र के ग्रेजुएट पुरुष उम्मीदवारों के लिए बेहतरीन मौका।
                  </span>
                </li>
              </ul>
      ...
      <aside
        ...
        style={{
          backgroundColor: "rgba(9, 19, 14, 1)",
        }}
      >
              <div>
                <h3 className="hero-form-title text-[18px] font-semibold mb-1">हमसे बात करें!</h3>
                <p className="hero-form-subtitle text-sm text-[rgba(250,250,250,0.6)] mb-3">हमारे काउंसलर से बात करके पूरी जानकारी लें।</p>
                <form
                  onSubmit={(e) => {
                    e.preventDefault();
                ...
                >
                    ...
                    <>
                      ...
                      {!alreadyInSystem && (
                        <p className="hero-form-otp-text text-[12px] leading-[18px] font-normal text-[rgba(250,250,250,0.6)]">
                          वेरिफिकेशन के लिए इस नंबर पर एक OTP भेजा जाएगा।
                        </p>
                      )}
                      {!alreadyInSystem && (
                        <div className="flex flex-col gap-3">
                          <label className="flex items-start gap-2 cursor-pointer">
                            ...
                            मैं समझता हूँ कि यह एक पेड जॉब-रेडी प्रोग्राम है और इसकी फीस देने के लिए तैयार हूँ।
                            </span>
                          </label>
                          ...
                          <label className="flex items-start gap-2 cursor-pointer">
                            ...
                            />
                            <span className="hero-form-consent-text">
                            मैं सहमति देता हूँ कि इस प्रोग्राम की जानकारी के लिए क्रैक-एड की टीम मेरे दिए गए मोबाइल नंबर पर मुझसे संपर्क कर सकती है।
                            </span>
                          </label>
                  ...
                  >
                    <button
                      ...
                      className="h-[52px] w-[206px] rounded-[10px] bg-[rgba(87,190,136,1)] hover:bg-[rgba(74,162,116,1)] text-[rgba(30,30,30,1)] text-[14px] font-medium tracking-[0.02em] shadow-[0_12px_30px_rgba(0,0,0,0.45)] transition-colors duration-200 disabled:opacity-70 disabled:cursor-not-allowed"
