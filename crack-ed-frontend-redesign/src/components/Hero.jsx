...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative max-lg:bg-black">
      {/* Hero background: grows with content on mobile; fixed height on desktop. Form comes after on mobile. */}
      <div
        className="hero-background w-full lg:h-[690px] relative overflow-hidden max-lg:overflow-visible"
        role="img"
      ...
      >
        ...
        />
        <div
          className="hero-background-overlay absolute inset-0 max-lg:relative max-lg:pb-10"
          style={{
            zIndex: 10,
            background:
          ...
          <div className="hero-container relative">
            <div className="absolute left-[120px] max-w-[773px] text-white left-adjust hero-left-adjust">
              ...
              <div className="hero-heading-block">
                <h1 className="hero-title">கிராக்-எட் (Crack-ED) கூட்டாளராகுங்கள்</h1>
                <p className="hero-tagline">
                ஒவ்வொரு மாணவர் சேர்க்கையிலும் வருமானம் பெறுங்கள். முன்பணம் முதலீடு தேவையில்லை.
                </p>
              </div>
              <ul className="hero-bullet-list space-y-3">
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  ஒவ்வொரு மாணவர் சேர்க்கையிலும் 12% வரை கமிஷன் பெறுங்கள்.
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span className="hero-bullet-text">
                  மாணவர்களுக்கு வேலைவாய்ப்பு சார்ந்த பயிற்சி திட்டங்களை அறிமுகப்படுத்தி கூடுதல் வருமானம் பெறுங்கள்.
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span className="hero-bullet-text">
                  10,000-க்கும் மேற்பட்ட கூட்டாளர் விற்பனையாளர்களின் (Vendor Partners) வலையமைப்பில் இணைந்து, மாதத்திற்கு ₹1.17 லட்சம் வரை சம்பாதியுங்கள்.
                  </span>
                </li>
              </ul>
            </div>
      ...
      >
        <div>
          <h3 className="hero-form-title text-[18px] font-semibold mb-1">இன்றே சம்பாதிக்கத் தொடங்குங்கள்!</h3>
          <p className="hero-form-subtitle text-sm mb-3">குறைந்த இடங்கள் மட்டுமே உள்ளன. இன்றே எங்கள் கூட்டாளர் வலையமைப்பில் சேருங்கள்.</p>
          <form
            onSubmit={(e) => {
              e.preventDefault();
              ...
              <>
                ...
                {!alreadyInSystem && (
                  <p className="hero-form-otp-text text-[12px] leading-[18px] font-normal">
                    சரிபார்ப்பிற்காக இந்த எண்ணுக்கு ஒரு OTP அனுப்பப்படும்.
                  </p>
                )}
              </>
            )}
