...
export default function Hero() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        trackPixelEvent("CompleteRegistration", {
          content_name: "Hero Finance - RM Telugu",
  ...
  return (
    <section
      id="hero"
      className="relative bg-black lg:pb-0"
    >
      ...
      <div
        className="w-full max-lg:min-h-0 lg:h-[690px] lg:min-h-0 bg-cover bg-no-repeat relative max-lg:bg-[20%_center] lg:bg-center"
        style={{ backgroundImage: `url(${heroImage})` }}
        role="img"
        aria-label="Aviva hero"
      >
        <div
          className="hero-gradient-overlay max-lg:relative max-lg:min-h-0 lg:absolute lg:inset-0"
          style={{
            zIndex: 10,
            background:
        ...
        >
          ...
          <div className="hero-container relative">
            <div className="absolute left-[120px] top-[135px] lg:top-[200px] w-[586px] max-w-[calc(100%-2rem)] text-white left-adjust hero-left-adjust">
              ...
              <div className="flex flex-col gap-2 max-lg:gap-3 w-full">
                ...
                <h1
                  className="hero-title text-[40px] sm:text-[40px] md:text-[40px] lg:text-[48px] font-semibold leading-[150%] tracking-[0em] mb-4"
                  style={{ fontFamily: "Montserrat, sans-serif" }}
                >
                  హోమ్ ఫైనాన్స్ రంగంలో హీరో అవ్వండి!
                </h1>
              </div>
              <ul className="hero-bullet-list text-gray-200 space-y-3 mb-8">
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  <span
                    className="hero-subtitle text-[16px] leading-[130%] font-normal tracking-[0em] text-[rgba(250,250,250,1)]"
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    మార్ట్గేజ్ సేల్స్ రిలేషన్‌షిప్ మేనేజర్‌గా కెరీర్ ప్రారంభించి ₹2.75 లక్షల వరకు వార్షిక CTCతో పాటు ఆకర్షణీయమైన ఇన్సెంటివ్‌లు పొందండి
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    మీ కొత్త ఉద్యోగంలో ఆత్మవిశ్వాసంతో అడుగుపెట్టేందుకు ప్రత్యేకంగా రూపొందించిన 1 నెల శిక్షణ కోర్స్.
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    30 సంవత్సరాల లోపు ఉన్న గ్రాడ్యుయేట్లకు ఫీల్డ్ సేల్స్ రిలేషన్‌షిప్ మేనేజర్‌గా ఉద్యోగ అవకాశం.
                  </span>
                </li>
              </ul>
              <div className="register-btn-wrap lg:mb-0">
                <a
      ...
      >
              <div>
                <h3 className="hero-form-title text-[18px] font-semibold mb-1">మాతో మాట్లాడండి!</h3>
                <p className="hero-form-subtitle text-sm text-[rgba(250,250,250,0.6)] mb-3">మా కౌన్సిలర్‌తో మాట్లాడి ప్రోగ్రామ్‌కి సంబంధించిన పూర్తి సమాచారాన్ని తెలుసుకోండి.</p>
                <form
                  onSubmit={(e) => {
                    e.preventDefault();
                      ...
                      {!alreadyInSystem && (
                        <div className="flex flex-col gap-3">
                          <label className="flex items-center gap-1.5 cursor-pointer">
                            ...
                            ఇది ఫీజు చెల్లించాల్సిన జాబ్-రెడీ (Job-Ready) ప్రోగ్రామ్ అని నేను అర్థం చేసుకున్నాను మరియు ఆ ఫీజును చెల్లించడానికి నేను సిద్ధంగా ఉన్నాను.
                            </span>
                          </label>
                          ...
                          <label className="flex items-center gap-1.5 cursor-pointer">
                            ...
                            />
                            <span className="hero-form-consent-text">
                            ఈ కార్యక్రమానికి సంబంధించిన సమాచారం కోసం క్రాక్-ఎడ్ (Crack-ED) బృందం నేను ఇచ్చిన మొబైల్ నంబర్‌ను సంప్రదించడానికి నా సమ్మతిని తెలియజేస్తున్నాను.
                            </span>
                          </label>
