      ...
      >
        ...
        >
          ...
          <div className="hero-container relative">
            <div className="absolute left-[120px] top-[210px] w-[586px] max-w-[calc(100%-2rem)] text-white left-adjust hero-left-adjust">
              <h1
                className="hero-title text-[40px] sm:text-[40px] md:text-[40px] lg:text-[48px] font-semibold leading-[100%] tracking-[0em] mb-4"
                style={{ fontFamily: "Montserrat, sans-serif" }}
              >
              Build Your Career, One Home at a Time
              </h1>
              <ul className="hero-bullet-list text-gray-200 space-y-3 mb-8">
                ...
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    Transition from candidate to Banking Professional in just 3 weeks
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    Professional banking training and placement support for only Rs 40,000.
                  </span>
                </li>
              </ul>
