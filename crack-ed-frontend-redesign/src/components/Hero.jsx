...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative max-lg:bg-black">
      {/* Hero: desktop fixed height; mobile stack grows with content so the CTA is not clipped or flush with the form. */}
      <div
        className="relative w-full overflow-hidden lg:h-[690px]"
        role="img"
        aria-label="Aviva hero"
      >
        <div
          className="absolute inset-0 bg-cover bg-no-repeat max-lg:bg-[40%_center] lg:bg-center scale-x-[-1]"
              ...
              <div className="flex flex-col gap-6">
                ...
                <ul className="hero-bullet-list text-gray-200 space-y-4">
                  ...
                  <li className="flex items-start gap-2 sm:gap-3">
                    ...
                    <span className="hero-subtitle font-normal text-[14px] leading-[1]">5-week program
                    </span>
                  </li>
                </ul>
              </div>
      ...
      <aside
        className={`hero-form-card max-lg:relative max-lg:mx-4 max-lg:mt-8 max-lg:max-w-[calc(100%-2rem)] lg:absolute lg:right-[120px] lg:top-[85px] lg:mt-0 lg:w-[373px] lg:z-30 w-full p-4 sm:p-6 lg:p-[24px_32px_28px_32px] rounded-2xl border border-[rgba(250,250,250,0.15)] flex flex-col justify-between min-h-0 ${
          alreadyInSystem || hasValidationError ? "lg:min-h-[520px]" : "lg:min-h-[471px]"
        }`}
        style={{
          backgroundColor: "rgba(1, 0, 20, 1)"
        }}
      >
              <div>
                ...
                >
                  ...
                  <div ref={stateRef} className="relative">
                    <div className="custom-select w-full px-4 h-[50px] rounded-[10px] bg-transparent border border-[rgba(250,250,250,0.12)] font-normal text-[14px] flex items-center justify-between gap-2 cursor-text">
                      <input
                        ref={stateInputRef}
                        type="text"
                        name="state"
