...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative max-lg:bg-black">
      ...
      <aside
        className={`hero-form-card max-lg:relative max-lg:mx-4 max-lg:mt-4 max-lg:max-w-[calc(100%-2rem)] lg:absolute lg:right-[120px] lg:top-[96px] lg:mt-0 lg:w-[373px] lg:z-30 w-full bg-[rgba(3,15,25,1)] p-4 sm:p-6 lg:p-[24px_32px_28px_32px] rounded-2xl border border-[rgba(250,250,250,0.15)] flex flex-col justify-between min-h-0 ${alreadyInSystem || hasValidationError ? "lg:min-h-[580px]" : "lg:min-h-[524px]"
          }`}
      >
        <div>
            ...
            {alreadyInSystem && (
              ...
              >
                ...
                <button
                  type="button"
                  onClick={() => setStatus(null)}
                  className="absolute top-3 right-3 w-5 h-5 flex items-center justify-center rounded text-[rgba(34,197,94,0.9)] hover:bg-[rgba(0,0,0,0.35)] transition-colors"
                  aria-label="Dismiss"
                >
                  <span className="text-lg leading-none">×</span>
                </button>
