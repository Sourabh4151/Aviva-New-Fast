            ...
            <div className="absolute left-[120px] top-[200px] w-[586px] max-w-[calc(100%-2rem)] text-white left-adjust hero-left-adjust">
              ...
              <ul className="hero-bullet-list text-gray-200 space-y-2 sm:space-y-4 mb-4 md:mb-8">
                ...
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  <span className="text-[14px] leading-[1] font-normal">2-week program
                  </span>
                </li>
              </ul>
                ...
                >
                  ...
                  <div ref={stateRef} className="relative">
                    <div
                      ...
                      className="custom-select w-full px-4 h-[50px] rounded-[10px] bg-transparent border border-[rgba(143,40,44,0.8)] outline-none focus:outline-none focus:ring-0 focus:border-[rgba(250,250,250,0.55)] font-normal text-[14px] flex items-center justify-between cursor-pointer"
                    >
