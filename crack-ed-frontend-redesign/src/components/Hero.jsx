...
import finovaLogo from "../assets/finova.svg";
...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative max-lg:bg-black">
      ...
      >
        <div
          className="absolute inset-0 bg-cover bg-no-repeat max-lg:bg-[40%_center] lg:bg-center"
              ...
              <div className="flex flex-col gap-6">
                ...
                <ul className="hero-bullet-list text-gray-200 space-y-4">
                  <li className="flex items-start gap-2 sm:gap-3">
                    ...
                    <span className="hero-subtitle font-normal text-[14px] leading-[1] lg:text-[16px]">
      ...
      <aside
        className={`hero-form-card max-lg:relative max-lg:mx-4 max-lg:mt-8 max-lg:max-w-[calc(100%-2rem)] lg:absolute lg:right-[120px] lg:top-[78px] lg:mt-0 lg:w-[373px] lg:z-30 w-full p-4 sm:p-6 lg:p-[24px_32px_28px_32px] rounded-2xl border border-[rgba(250,250,250,0.15)] flex flex-col justify-between min-h-0 ${
          alreadyInSystem || hasValidationError ? "lg:min-h-[520px]" : "lg:min-h-[471px]"
        }`}
        style={{
          backgroundColor: "rgba(25, 4, 13, 1)"
        }}
      >
              <div>
