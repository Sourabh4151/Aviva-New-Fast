    ...
    <section id="hero" className="relative max-lg:bg-black">
          ...
          <div className="hero-container relative">
            <div className="absolute left-[120px] max-w-[773px] text-white left-adjust hero-left-adjust">
              ...
              <div className="hero-heading-block">
                <h1 className="hero-title">क्रैक-एड पार्टनर बनें</h1>
                <p className="hero-tagline">
                हर छात्र के एडमिशन पर कमाएँ। बिना किसी शुरुआती निवेश के।
                </p>
              </div>
              <ul className="hero-bullet-list space-y-3">
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  हर एडमिशन पर आकर्षक कमीशन कमाएँ और परफॉर्मेंस के आधार पर 12% तक अतिरिक्त इंसेंटिव पाएँ।
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span className="hero-bullet-text">
                  उन जॉब-लिंक्ड प्रोग्राम्स के साथ पार्टनर बनें जिन्हें उम्मीदवार खोज रहे हैं।
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span className="hero-bullet-text">
                  10,000+ पार्टनर्स के नेटवर्क से जुड़ें, जहाँ पार्टनर्स ने एक महीने में ₹1.17 लाख तक की कमाई की है।
                  </span>
                </li>
              </ul>
            </div>
      ...
      >
        <div>
          ...
          <p className="hero-form-subtitle text-sm mb-3">सीमित सीटें उपलब्ध हैं, आज ही हमारे पार्टनर नेटवर्क से जुड़ें।</p>
          <form
            onSubmit={(e) => {
              e.preventDefault();
