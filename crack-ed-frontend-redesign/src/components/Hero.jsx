...
export default function Hero() {
  const BROCHURE_PDF_PATH = "/Banking%20Sales%20Program.pdf";
  ...
  function handleDownloadBrochure() {
    ...
    link.download = "Banking Sales Program.pdf";
  ...
  return (
    <section id="hero" className="relative max-lg:bg-black">
      ...
      <div
        className="w-full min-h-[730px] sm:min-h-[770px] lg:h-[690px] bg-cover bg-no-repeat relative max-lg:bg-[32%_center] lg:bg-center"
        ...
        >
          ...
          <div className="hero-container relative">
            <div className="absolute left-[120px] top-[155px] lg:top-[230px] w-[586px] max-w-[calc(100%-2rem)] text-white left-adjust hero-left-adjust">
              <h1
                className="hero-title text-[40px] sm:text-[40px] md:text-[40px] lg:text-[48px] font-semibold leading-[140%] tracking-[0em] mb-4"
                style={{ fontFamily: "Montserrat, sans-serif" }}
              >
                नए मौके, नई पहचान, नए भविष्य की शुरुआत
              </h1>
              <ul className="hero-bullet-list text-gray-200 space-y-3 mb-8">
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  >
                    सेल्स ऑफिसर बनें और पाएं ₹2.5 लाख सालाना CTC + आकर्षक इंसेंटिव।
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    नई नौकरी की शुरुआत आसान बनाने के लिए 3 महीने की विशेष ट्रेनिंग।
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    अगर आप ग्रेजुएट हैं, आपके पास वैध ड्राइविंग लाइसेंस और अपनी दोपहिया गाड़ी है, तो आप शुरुआत करने के लिए तैयार हैं।
                  </span>
                </li>
              </ul>
