...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative max-lg:bg-black">
            ...
            <div className="absolute left-[120px] top-[200px] w-[586px] max-w-[calc(100%-2rem)] text-white left-adjust hero-left-adjust">
              ...
              <ul className="hero-bullet-list space-y-2 sm:space-y-4 mb-4 md:mb-8">
                ...
                <li className="flex items-center gap-2 sm:gap-3">
                  ...
                  <span className="hero-subtitle">6-month program
                  </span>
                </li>
              </ul>
      ...
      <aside
        className={`hero-form-card max-lg:relative max-lg:mx-4 max-lg:mt-4 max-lg:max-w-[calc(100%-2rem)] lg:absolute lg:right-[120px] lg:top-[88px] lg:mt-0 lg:w-[373px] lg:z-30 w-full p-4 sm:p-6 lg:p-[24px_32px_28px_32px] rounded-2xl border border-[rgba(250,250,250,0.15)] flex flex-col justify-between min-h-0 ${alreadyInSystem || hasValidationError ? "lg:min-h-[580px]" : "lg:min-h-[524px]"
          }`}
        style={{
