...
/** Empty string in local dev uses Vite proxy (same origin). Production sets VITE_BASE_URL. */
...
export default function Hero() {
  ...
  async function verifyOtp(e) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const errMsg = json.message || json.error || "Invalid OTP";
  ...
  return (
    <section id="hero" className="relative max-lg:bg-black">
      ...
      <div
        className="w-full min-h-[520px] sm:min-h-[600px] lg:h-[690px] bg-cover bg-no-repeat relative max-lg:bg-[2%_center] lg:bg-center"
          ...
          <div className="hero-container relative">
            <div className="absolute left-[120px] top-[200px] w-[586px] max-w-[calc(100%-2rem)] text-white left-adjust hero-left-adjust">
              <div className="hero-logo-badge mb-3 md:mb-4">
                <div
                  className="hero-badge mt-4 md:mt-6 inline-flex items-center justify-center text-center text-[14px] font-semibold text-white rounded-full border border-white px-4 py-2"
                >
                  Postgraduate Program - Retail Banking
                </div>
              </div>
              ...
              <ul className="hero-bullet-list text-gray-200 space-y-2 sm:space-y-4 mb-4 md:mb-8">
                ...
                <li className="flex items-start gap-2 sm:gap-3 min-w-0">
                  ...
                  <span className="hero-bullet-secondary min-w-0 max-sm:max-w-[331px] text-[14px] sm:text-[16px] leading-[1.45] font-normal font-['Poppins',ui-sans-serif,system-ui,sans-serif] text-[rgba(250,250,250,1)]">3-week program
                  </span>
                </li>
              </ul>
              <div className="register-btn-wrap mt-4">
                <a
                  href="/PGP%20in%20Retail%20Banking.pdf"
                  className="download-brochure-btn"
                  download="PGP - Retail Banking.pdf"
                >
                  Download Brochure
                </a>
              </div>
      ...
      <aside
        className={`hero-form-card max-lg:relative max-lg:mx-4 max-lg:mt-6 max-lg:max-w-[calc(100%-2rem)] lg:absolute lg:right-[120px] lg:top-[88px] lg:mt-0 lg:w-[373px] lg:z-30 w-full p-4 sm:p-6 lg:p-[24px_32px_28px_32px] rounded-2xl border border-[rgba(250,250,250,0.15)] flex flex-col justify-between min-h-0 ${alreadyInSystem || hasValidationError ? "lg:min-h-[583px]" : "lg:min-h-[534px]"
          }`}
        style={{
          backgroundColor: "rgba(0,0,0,1)",
          backgroundImage: "linear-gradient(rgba(143,40,44,0.15), rgba(143,40,44,0.15))",
        }}
      >
        <div>
          ...
          >
            ...
            <div ref={cityRef} className="relative">
              <div
                ...
                className={`custom-select w-full px-4 h-[50px] rounded-[10px] bg-transparent border border-[rgba(250,250,250,0.3)] outline-none focus-within:border-[rgba(250,250,250,0.55)] font-normal text-[14px] flex items-center justify-between gap-2 ${form.state ? "cursor-text" : "cursor-not-allowed opacity-60"
                  }`}
              >
                {form.state ? (
                  <input
