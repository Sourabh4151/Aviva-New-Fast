...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative max-lg:bg-black">
      {/* Hero background: grows with content on mobile so form stacks below; fixed height on desktop */}
      <div
      ...
      <aside
        className={`hero-form-card max-lg:relative max-lg:z-20 max-lg:mx-4 max-lg:mt-6 max-lg:mb-4 max-lg:max-w-[calc(100%-2rem)] lg:absolute lg:right-[120px] lg:top-[75px] lg:mt-0 lg:w-[373px] lg:z-30 w-full p-4 sm:p-6 lg:p-[24px_32px_28px_32px] rounded-2xl border border-[rgba(250,250,250,0.15)] flex flex-col justify-between min-h-0 ${alreadyInSystem || hasValidationError ? "lg:min-h-[580px]" : "lg:min-h-[524px]"
          }`}
        style={{
          backgroundColor: "rgba(6, 10, 43, 1)",
        }}
      >
        <div>
