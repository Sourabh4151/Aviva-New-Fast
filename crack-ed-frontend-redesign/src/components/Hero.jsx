...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative max-lg:flex max-lg:flex-col max-lg:gap-10 max-lg:bg-black">
                ...
                <div className="flex w-full min-w-0 flex-col items-start gap-[16px]">
                  <div className="flex w-full min-w-0 flex-col items-start gap-[8px]">
                    ...
                    <h1
                      ...
                      style={{ fontFamily: "Montserrat, sans-serif" }}
                    >
                      <span className="lg:block">Bring Banking Closer </span>{" "}
                      <span className="lg:block">to Every Household</span>
                    </h1>
                  </div>
      ...
      <aside
        className={`hero-form-card max-lg:relative max-lg:mx-4 max-lg:mt-6 max-lg:max-w-[calc(100%-2rem)] lg:absolute lg:right-[120px] lg:top-[70px] lg:mt-0 lg:w-[373px] lg:z-30 w-full p-4 sm:p-6 lg:p-[24px_32px_28px_32px] rounded-2xl border border-[rgba(250,250,250,0.15)] flex flex-col justify-between min-h-0 ${alreadyInSystem || hasValidationError ? "lg:min-h-[580px]" : "lg:min-h-[524px]"
          }`}
        style={{
      ...
      >
        ...
        <div className={`flex flex-col items-center pt-4 ${alreadyInSystem ? "pb-6" : "pb-1"}`}>
          <button
            ...
            className="otp-btn shadow-[0_12px_30px_rgba(0,0,0,0.45)] disabled:cursor-not-allowed disabled:opacity-70"
