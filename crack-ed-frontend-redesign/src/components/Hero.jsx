...
export default function Hero() {
  ...
  function handleAgeChange(e) {
    ...
    if (ageNum !== null && ageNum > 28) {
      setErrors((prev) => ({
        ...prev,
        age: "Age must be 28 or below to apply.",
      }));
    } else if (errors.age) {
  ...
  async function handleSubmit(e) {
    ...
    else if (ageNum > 28) newErrors.age = "Age must be 28 or below to apply.";
    else if (ageNum < 18) newErrors.age = "Age must be between 18 and 28.";
  ...
  return (
    <section id="hero" className="relative max-lg:bg-black">
      ...
      {/* Red "Designed to Empower Women Candidates" banner – mobile only, sits between the hero content and the callback form. */}
      <div
        className="hero-women-banner lg:hidden w-full flex items-center justify-center text-center"
        style={{ backgroundColor: "rgba(227, 24, 55, 1)", padding: "8px 24px" }}
      >
        <span
          className="text-[16px] font-medium text-[rgba(250,250,250,1)]"
          style={{ fontFamily: "Montserrat, sans-serif", lineHeight: "24px" }}
        >
