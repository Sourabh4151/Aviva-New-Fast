...
export default function Hero() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        trackPixelEvent("CompleteRegistration", {
          content_name: "PGP Assistant Manager",
  ...
  return (
    <section id="hero" className="relative bg-black max-lg:pb-[calc(2rem+env(safe-area-inset-bottom,0px))] lg:pb-0">
      ...
      >
        <div
          className="absolute inset-0 max-lg:relative max-lg:inset-auto max-lg:min-h-[670px]"
          style={{
            zIndex: 10,
            background:
        ...
        >
          ...
          <div className="hero-container relative">
            <div className="absolute left-[120px] top-[150px] w-[586px] max-w-[calc(100%-2rem)] text-white left-adjust hero-left-adjust">
              <h1
                className="hero-title max-lg:text-[40px] lg:w-[586px] lg:text-[48px] font-semibold leading-[130%] tracking-[0] text-[rgba(250,250,250,1)] mb-6"
                style={{ fontFamily: "Montserrat, sans-serif", fontWeight: 600 }}
              >
                180 రోజుల్లో ఫ్రెషర్ నుంచి మేనేజర్‌గా ఎదగండి
              </h1>
              <ul className="hero-bullet-list text-gray-200 space-y-5 mb-8">
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span
                    className="hero-subtitle text-[16px] leading-[160%] font-normal tracking-[0em] text-[rgba(250,250,250,1)]"
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    అసిస్టెంట్ మేనేజర్‌గా చేరి, ఫైనాన్స్ ప్రపంచంలో నైపుణ్యం సాధిస్తూ ₹4 లక్షల వార్షిక CTCతో పాటు ఆకర్షణీయమైన ఇన్సెంటివ్స్ పొందండి.
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    28 సంవత్సరాల లోపు ఉన్న, చదువు నుంచి వృత్తి జీవితంలో నాయకత్వ పాత్రలోకి అడుగుపెట్టేందుకు సిద్ధంగా ఉన్న ఉత్సాహభరితమైన గ్రాడ్యుయేట్ల కోసం ప్రత్యేకంగా రూపొందించిన అవకాశం.
                  </span>
                </li>
              </ul>
              <div className="register-btn-wrap max-lg:mb-0">
                <a
                ...
                >
                  బ్రోషర్‌ను డౌన్‌లోడ్ చేయండి
                </a>
                <p className="mt-3 mb-0 text-[14px] leading-[140%] tracking-[0em] text-[rgba(250,250,250,0.8)]">
                * నెలకు ₹6,000 నుండి ప్రారంభమయ్యే EMI సౌకర్యం అందుబాటులో ఉంది.
                </p>
              </div>
            </div>
          </div>
      ...
      <aside
        className="hero-form-card max-lg:relative max-lg:mx-4 max-lg:mt-8 max-lg:mb-16 max-lg:max-w-[calc(100%-2rem)] lg:absolute lg:right-[120px] lg:top-[45px] lg:mt-0 lg:w-[520px] lg:z-30 w-full p-4 sm:p-6 lg:p-[24px_32px_28px_32px] rounded-2xl border border-[rgba(250,250,250,0.15)] flex flex-col gap-4 min-h-0 h-fit"
        style={{
          backgroundColor: "rgba(0, 14, 25, 1)",
        }}
      >
        <div>
          <h3 className="hero-form-title text-[18px] font-semibold mb-1">కాల్‌బ్యాక్ కోసం అభ్యర్థించండి!</h3>
          <p className="hero-form-subtitle text-sm text-[rgba(250,250,250,0.6)] mb-3">మరింత సమాచారం కోసం మా కౌన్సిలర్‌లతో మాట్లాడండి.</p>
          <form
            onSubmit={(e) => {
              e.preventDefault();
                ...
                {!alreadyInSystem && (
                  <div className="flex flex-col gap-3">
                    <label className="flex items-start gap-2 cursor-pointer">
                      ...
                      ఇది ఫీజు చెల్లించాల్సిన జాబ్-రెడీ (Job-Ready) ప్రోగ్రామ్ అని నేను అర్థం చేసుకున్నాను మరియు వర్తించే ప్రోగ్రామ్ ఫీజును చెల్లించడానికి అంగీకరిస్తున్నాను.
                      </span>
                    </label>
                    ...
                    <label className="flex items-start gap-2 cursor-pointer">
                      ...
                      />
                      <span className="hero-form-consent-text">
                      ఈ కార్యక్రమానికి సంబంధించిన సమాచారం కోసం క్రాక్-ఎడ్ (Crack-ED) బృందం నేను అందించిన మొబైల్ నంబర్‌ను సంప్రదించడానికి నా సమ్మతిని తెలియజేస్తున్నాను.
                      </span>
                    </label>
