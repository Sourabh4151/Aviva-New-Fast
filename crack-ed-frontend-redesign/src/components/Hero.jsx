...
import piramalLogo from "../assets/piramal.svg";
...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative max-lg:bg-black">
      ...
      >
        <div
          className="absolute inset-0 bg-cover bg-no-repeat max-lg:bg-[40%_center] lg:bg-center -scale-x-100"
          ...
          <div className="hero-container relative max-lg:pb-6">
            <div className="absolute left-[120px] top-[200px] w-[586px] max-w-[calc(100%-2rem)] text-white left-adjust hero-left-adjust flex flex-col gap-8">
              <div className="flex flex-col gap-6">
                <div className="flex flex-col gap-4">
                  <img
                    src={piramalLogo}
                    alt="Piramal logo"
                    className="w-[117px] h-[56px] object-contain"
                  />
                ...
                <ul className="hero-bullet-list text-gray-200 space-y-4">
                  ...
                  <li className="flex items-start gap-2 sm:gap-3">
                    ...
                    <span className="hero-subtitle font-normal text-[16px] leading-[1] lg:font-normal lg:text-[16px] lg:leading-[1] lg:tracking-[0] lg:text-[rgba(250,250,250,1)]">13-week program
                    </span>
                  </li>
                </ul>
              </div>
              <div className="register-btn-wrap">
                <a
                  href="/Piramal%20ProEdge%20Program.pdf"
                  className="download-brochure-btn"
                  download="Piramal ProEdge Program.pdf"
                >
                  Download Brochure
                </a>
              </div>
      ...
      <aside
        ...
        style={{
          ...
          backgroundImage:
            "linear-gradient(rgba(236, 64, 35, 0.1), rgba(236, 64, 35, 0.1))",
        }}
      >
              <div>
