...
export default function Hero() {
  ...
  const brochurePdfPath = "/FLS - Agency.pdf";
  const brochurePdfHref = encodeURI(brochurePdfPath);
  const brochurePdfDownloadName = "FLS - Agency.pdf";
    ...
    try {
      ...
      if (res.ok) {
        ...
        trackPixelEvent("CompleteRegistration", {
          content_name: "Aviva - AS Kannada Program",
        ...
        >
          ...
          <div className="hero-container relative">
            <div className="absolute left-[120px] top-[155px] lg:top-[100px] w-[586px] max-w-[calc(100%-2rem)] max-lg:w-full max-lg:max-w-full text-white left-adjust hero-left-adjust">
              ...
              >
                ಮಾರಾಟ ಮಾಡುವುದಷ್ಟೇ ಏಕೆ? ಈಗ ತಂಡವನ್ನು ಮುನ್ನಡೆಸುವ ಅವಕಾಶ ನಿಮ್ಮದು!
              </h1>
              <ul className="hero-bullet-list text-gray-200 space-y-3 mb-8">
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  >
                    ಫ್ರಂಟ್ ಲೈನ್ ಸೇಲ್ಸ್ ಎಕ್ಸಿಕ್ಯೂಟಿವ್ – ಏಜೆನ್ಸಿ ಸೇಲ್ಸ್ ಆಗಿ ಸೇರಿ ಮತ್ತು ₹3.5 ಲಕ್ಷ ವಾರ್ಷಿಕ CTC ಜೊತೆಗೆ ಆಕರ್ಷಕ ವೇರಿಯಬಲ್ ವೇತನ  ಪಡೆಯಿರಿ.  
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                ...
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                   30 ವರ್ಷಗಳೊಳಗಿನ, ನಾಯಕತ್ವದ ಗುಣಗಳನ್ನು ಬೆಳೆಸಿಕೊಳ್ಳಲು ಮತ್ತು ತಂಡಗಳನ್ನು ನಿರ್ವಹಿಸುವ ಆಸಕ್ತಿ ಹೊಂದಿರುವ ಮಹತ್ವಾಕಾಂಕ್ಷಿ ಪದವೀಧರರಿಗೆ.
                  </span>
                </li>
              </ul>
