...
import rupyyLogo from "../assets/kotak_logo.svg";
    ...
    try {
      ...
      if (res.ok) {
        ...
        trackPixelEvent("CompleteRegistration", {
          content_name: "Kotak Mahindra Bank Sales Officer Program",
        ...
        >
          ...
          <div className="hero-container relative">
            <div className="absolute left-[120px] top-[155px] lg:top-[230px] w-[586px] max-w-[calc(100%-2rem)] text-white left-adjust hero-left-adjust">
              <div className="hero-logo-badge mb-2 w-[210px] h-[61px] overflow-hidden">
                <img
                  src={rupyyLogo}
              ...
              >
                Drive Dreams. Drive Your Future.
              </h1>
              <ul className="hero-bullet-list text-gray-200 space-y-3 mb-8">
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  >
                    Join as a Sales Officer and secure a CTC of Rs Rs 2.75 LPA + incentives
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                ...
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    Designed for graduates aged 30 years or below who are ready to build a successful career in dealership sales.
                  </span>
                </li>
              </ul>
          ...
          >
            ...
            >
              <button
                ...
                className="h-[52px] w-[206px] rounded-[10px] bg-[rgba(228,19,37,1)] hover:bg-[rgba(196,16,32,1)] text-white text-[14px] font-medium tracking-[0.02em] shadow-[0_12px_30px_rgba(0,0,0,0.45)] transition-colors duration-200 disabled:opacity-70 disabled:cursor-not-allowed"
