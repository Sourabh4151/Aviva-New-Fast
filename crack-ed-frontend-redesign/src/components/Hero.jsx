...
import quessLogo from "../assets/quess_logo.svg";
...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative max-lg:bg-black">
      ...
      <div
        className="w-full min-h-[730px] sm:min-h-[770px] lg:h-[690px] bg-cover bg-no-repeat relative max-lg:bg-[30%_center] lg:bg-center"
      ...
      >
        ...
        >
          ...
          <div className="hero-container relative">
            <div className="absolute left-[120px] top-[155px] lg:top-[200px] w-[586px] max-w-[calc(100%-2rem)] text-white left-adjust hero-left-adjust">
              <img
                src={quessLogo}
                alt="QUESS"
                className="hero-logo-badge block w-[138px] h-[43px] object-contain mb-4"
              />
              <h1
                className="hero-title text-[40px] sm:text-[40px] md:text-[40px] lg:text-[48px] font-semibold leading-[100%] tracking-[0em] mb-4"
                style={{ fontFamily: "Montserrat, sans-serif" }}
              >
                Bring Banking Closer to Every Household
              </h1>
              <ul className="hero-bullet-list text-gray-200 space-y-3 mb-8">
                ...
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    Build trusted customer relationships and bring banking services closer to every community.
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    1-week training designed to prepare you for the role
                  </span>
                </li>
              </ul>
