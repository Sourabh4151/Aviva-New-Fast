...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative max-lg:flex max-lg:flex-col max-lg:gap-16 max-lg:bg-black">
      {/* Hero background: fixed height on desktop; on mobile the inner wrapper grows with content so the form does not overlap the CTA. */}
      <div
                ...
                <div className="flex w-full min-w-0 flex-col items-start gap-[16px]">
                  <div className="flex w-full min-w-0 flex-col items-start gap-[8px]">
                    <img
                      ...
                      width={200}
                      height={65}
                      className="block h-[65px] w-[200px] shrink-0 object-contain"
                    />
                    <div
                  ...
                  <div className="flex w-full min-w-0 flex-col items-start gap-[20px]">
                    ...
                    <li className="flex items-start gap-2 sm:gap-3">
                      ...
                      <span
                        ...
                        style={{ fontFamily: "Poppins, sans-serif" }}
                      >
                        Secure a CTC of ₹3 LPA (Fixed) + Performance Linked Pay* 
                      </span>
                    </li>
                    <li className="flex items-start gap-2 sm:gap-3">
                      <span className="hero-tick">
                    ...
                    <p
                      className="shrink-0 whitespace-nowrap text-[12px] font-normal leading-[100%] tracking-[0em] text-[rgba(255,255,255,1)]"
