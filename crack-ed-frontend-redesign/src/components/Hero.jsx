...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative max-lg:bg-black">
        ...
        >
          ...
          <div className="hero-container relative">
            <div className="absolute left-[120px] top-[200px] w-[586px] max-w-[calc(100%-2rem)] text-white left-adjust hero-left-adjust">
              ...
              <ul className="hero-bullet-list space-y-3 sm:space-y-4 mb-4 md:mb-8">
      ...
      <aside
        className={`hero-form-card max-lg:relative max-lg:mx-4 max-lg:mt-10 max-lg:mb-6 max-lg:max-w-[calc(100%-2rem)] lg:absolute lg:right-[120px] lg:top-[70px] lg:mt-0 lg:w-[373px] lg:z-30 w-full p-4 sm:p-6 lg:p-[24px_32px_28px_32px] rounded-2xl border border-[rgba(250,250,250,0.15)] flex flex-col justify-between min-h-0 ${alreadyInSystem || hasValidationError ? "lg:min-h-[620px]" : "lg:min-h-[568px]"
          }`}
        style={{
          ...
          >
            ...
            <div ref={cityRef} className="relative">
              <div
                ...
                className={`custom-select w-full px-4 h-[50px] rounded-[10px] bg-transparent border border-[rgba(250,250,250,0.3)] outline-none font-normal text-[14px] flex items-center justify-between gap-2 ${form.state
                  ? "cursor-text focus-within:border-[rgba(250,250,250,0.55)]"
