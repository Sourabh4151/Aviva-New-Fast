...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative max-lg:bg-black max-lg:pb-[calc(2rem+env(safe-area-inset-bottom,0px))] lg:pb-0"
    >
            ...
            <div className="absolute left-[120px] top-[135px] w-[586px] max-w-[calc(100%-2rem)] text-white left-adjust hero-left-adjust">
              ...
              <div className="register-btn-wrap max-lg:mb-4">
                <button
                  ...
                  aria-label="Download brochure (temporarily unavailable)"
                >
                  Download Brochure
                </button>
              </div>
      ...
      <aside
        className={`hero-form-card max-lg:relative max-lg:mx-4 max-lg:mt-4 max-lg:max-w-[calc(100%-2rem)] lg:absolute lg:right-[120px] lg:top-[85px] lg:mt-0 lg:w-[373px] lg:z-30 w-full p-4 sm:p-6 lg:p-[24px_32px_28px_32px] rounded-2xl border border-[rgba(250,250,250,0.15)] flex flex-col justify-between min-h-0 ${
      ...
      >
              ...
              <div
                className={`flex flex-col items-center pt-4 ${alreadyInSystem ? "pb-6" : "max-lg:pb-6 lg:pb-1"}`}
              >
                <button
                  type="button"
                  onClick={(e) => (showOtp ? verifyOtp(e) : handleSubmit(e))}
                  className={`h-[52px] w-[206px] rounded-[10px] text-white text-[14px] font-medium tracking-[0.02em] shadow-[0_12px_30px_rgba(0,0,0,0.45)] transition-colors duration-200 disabled:opacity-70 disabled:cursor-not-allowed ${
                    showOtp
                      ? "bg-[rgba(227,24,55,1)] hover:bg-[rgba(159,17,38,1)]"
                      : "bg-[rgba(58,45,125,1)] hover:bg-[rgba(58,45,125,0.7)]"
                  }`}
