    ...
    try {
      ...
      if (res.ok) {
        ...
        trackPixelEvent("CompleteRegistration", {
          content_name: "Hero Finance - RM Program",
      ...
      >
        ...
        >
          ...
          <div className="hero-container relative">
            <div className="absolute left-[120px] top-[135px] lg:top-[150px] w-[586px] max-w-[calc(100%-2rem)] text-white left-adjust hero-left-adjust">
              ...
              <div className="flex flex-col gap-2 w-full">
                ...
                <h1
                  className="hero-title text-[40px] sm:text-[40px] md:text-[40px] lg:text-[48px] font-semibold leading-[125%] tracking-[0em] mt-1 mb-6"
                  style={{ fontFamily: "Montserrat, sans-serif" }}
                >
                  होम फाइनेंस में बनें सफलता के हीरो
                </h1>
              </div>
              <ul className="hero-bullet-list text-gray-200 space-y-3 mb-8">
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  >
                    रिलेशनशिप मैनेजर – मॉर्गेज सेल्स बनें और पाएं ₹2.75 लाख सालाना CTC + आकर्षक इंसेंटिव।
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                ...
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    30 साल से कम उम्र के ग्रेजुएट युवाओं के लिए बेहतरीन मौका। अगर आप रोज़ फील्ड में काम करने और आगे बढ़ने के लिए तैयार हैं, तो यह अवसर आपके लिए है।
                  </span>
                </li>
              </ul>
