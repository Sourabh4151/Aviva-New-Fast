      ...
      >
        ...
        <div className="absolute inset-0 z-10 max-lg:relative max-lg:inset-auto">
          <div className="hero-container relative">
            <div className="absolute left-[120px] top-[268px] w-[586px] max-w-[calc(100%-2rem)] text-white left-adjust hero-left-adjust">
              <h1
              ...
              <ul className="hero-bullet-list text-gray-200 space-y-3 mb-0 lg:mb-8">
                ...
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    Build meaningful client relationships and drive real business impact through high-value conversations
                  </span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <img src={tickSvg} alt="" aria-hidden="true" className="hero-tick-icon" />
                  <span
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    4-week training designed to prepare you for the role
                  </span>
                </li>
              </ul>
            </div>
