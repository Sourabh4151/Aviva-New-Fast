        ...
        >
          ...
          <div className="hero-container relative">
            ...
            <div className="hero-left-adjust absolute left-[120px] top-[130px] flex w-[586px] max-w-[calc(100%-2rem)] min-w-0 flex-col items-start gap-[8px] text-white left-adjust">
              <div className="hero-logo-badge flex h-[58px] w-[174px] max-w-full shrink-0 items-center justify-center rounded-sm bg-white">
                <img
                  src={heroLogo}
                ...
                <div className="flex w-full min-w-0 flex-col items-start gap-[16px]">
                  <div className="flex w-full min-w-0 flex-col items-start gap-[8px]">
                    ...
                    <h1
                      ...
                      style={{ fontFamily: "Montserrat, sans-serif" }}
                    >
                      <span className="lg:block">Be a Hero in Home</span>{" "}
                      <span className="lg:block">Finance</span>
                    </h1>
                  </div>
