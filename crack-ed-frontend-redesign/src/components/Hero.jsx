...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative max-lg:bg-black">
      ...
      <div
        className="w-full min-h-[520px] sm:min-h-[600px] lg:h-[690px] bg-cover bg-no-repeat max-lg:bg-[40%_center] lg:bg-center relative scale-x-[-1]"
              ...
              <div className="flex flex-col gap-6">
                ...
                <ul className="hero-bullet-list text-gray-200 space-y-4">
                  ...
                  <li className="flex items-start gap-2 sm:gap-3">
                    ...
                    <span className="hero-subtitle font-normal text-[14px] leading-[1]">2-month program
                    </span>
                  </li>
                </ul>
              </div>
      ...
      <aside
        className={`hero-form-card max-lg:relative max-lg:mx-4 max-lg:mt-6 max-lg:max-w-[calc(100%-2rem)] lg:absolute lg:right-[120px] lg:top-[72px] lg:mt-0 lg:w-[373px] lg:z-30 w-full bg-[rgba(3,15,25,1)] p-4 sm:p-6 lg:p-[24px_32px_28px_32px] rounded-2xl border border-[rgba(250,250,250,0.15)] flex flex-col justify-between min-h-0 ${
