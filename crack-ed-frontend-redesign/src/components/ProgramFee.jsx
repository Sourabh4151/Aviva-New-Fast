          ...
          <div className="flex-1 flex justify-center lg:justify-end w-full lg:w-auto">
            <div className="relative w-full max-w-[364px]">
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle at 0% 50%, rgba(0, 185, 237, 1) 0, transparent 60%), radial-gradient(circle at 100% 50%, rgba(0, 185, 237, 1) 0, transparent 60%), radial-gradient(circle at 50% 0%, rgba(0, 185, 237, 1) 0, transparent 60%), radial-gradient(circle at 50% 100%, rgba(0, 185, 237, 1) 0, transparent 60%)",
                  filter: "blur(300px)",
                  opacity: 1,
                }}
              />
