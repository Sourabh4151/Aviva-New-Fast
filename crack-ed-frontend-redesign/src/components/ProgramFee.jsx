            ...
            <div className="mt-4 flex flex-col gap-4 max-w-full lg:max-w-[498px]">
              ...
              >
                *Flexible EMI and education financing partners available.
                <br />
                *Boarding and lodging are not included in the program fees. Candidates are required to make their own arrangements for accommodation and meals at their own expense.
              </p>
            </div>
          </div>
          ...
          <div className="flex-1 flex justify-center lg:justify-end w-full lg:w-auto">
            <div className="relative w-full max-w-[364px]">
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle at 50% 50%, rgba(228, 19, 37, 0.7) 0, rgba(3, 149, 218, 0.0) 65%)",
                  filter: "blur(35px)",
                  opacity: 1,
                }}
              />
