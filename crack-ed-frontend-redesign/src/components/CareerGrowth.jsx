...
import frontLineSalesExecutive from "../assets/branch manager.jpg";
import seniorFrontLineSalesExecutive from "../assets/branch sales manager.jpg";
import frontLineSalesAssistantManager from "../assets/relationship manager (2).jpg";
import frontLineSalesDeputyManager from "../assets/assistant manager.jpg";
...
const ROLE_STEPS = [
  ...
  {
    key: "sflse",
    label: "Senior Gold Assayer",
    icon: sflseIcon,
    image: seniorFrontLineSalesExecutive,
  },
  {
    key: "flsam",
    label: "Branch Gold Manager",
    icon: flsamIcon,
    image: frontLineSalesAssistantManager,
  },
  {
    key: "flsdm",
    label: "Area Gold Manager",
    icon: flsdmIcon,
