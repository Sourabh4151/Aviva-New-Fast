...
const CAREER_STAGES = [
  {
    ...
    description:
      "Engage with customers through calls, understand their banking needs, and recommend suitable financial products and services.",
  },
  {
    title: "Senior Virtual Relationship Manager",
    description:
      "Manage customer portfolios, strengthen client relationships, and drive sales growth through virtual banking interactions.",
  },
  {
    title: "Assistant Manager",
    description:
      "Lead virtual sales and customer engagement activities, support team performance, and ensure smooth service delivery and business growth.",
  },
];
          ...
          <div className="w-full lg:w-[430px] flex-shrink-0">
            ...
            <div className="mt-3 sm:mt-4">
              <p className="career-growth-subtitle text-lg sm:text-xl lg:text-2xl font-medium text-white text-justify leading-tight">
                From your first role in the banking industry to bigger opportunities.
              </p>
              <p className="career-growth-body mt-3 sm:mt-4 font-normal text-[16px] leading-[24px] text-[rgba(250,250,250,0.8)] text-justify">
                Designed as a strong entry point with a clear path to grow within the banking industry.
              </p>
            </div>
            ...
            <div className="mt-3 sm:mt-4 space-y-0">
              {[
                {
                  text: "Start your career in banking sales and relationship management",
                  icon: careerIcon,
                  textClassName:
                    "font-medium text-[18px] leading-[1] text-[rgba(250,250,250,1)]",
                },
                {
                  text: "Earn a CTC of up to Rs. 2.4 LPA + incentives",
                  icon: ctcIcon,
                  textClassName:
                    "font-medium text-[18px] leading-[27px] text-[rgba(250,250,250,1)]",
                },
                {
                  text: "Grow into senior and leadership roles within the industry",
                  icon: growthIcon,
                  textClassName:
                    "font-medium text-[18px] leading-[1] text-[rgba(250,250,250,1)]",
                  alignBottomDot: true,
