...
const CAREER_STAGES = [
  {
    ...
    description:
      "Connect with customers, understand their financial needs, and help them choose the right retail lending solutions.",
  },
  {
    title: "Assistant Manager",
    description:
      "Support sales operations, manage customer relationships, and drive business growth through loan product sales and cross-selling.",
  },
  {
    title: "Deputy Manager",
    description:
      "Lead sales initiatives, oversee team performance, and strengthen customer acquisition and portfolio growth in retail lending.",
  },
  {
    title: "Area Sales Manager",
    description:
      "Manage regional sales teams, drive market expansion, and ensure business targets are achieved across multiple locations.",
  },
];
...
const FEATURES = [
  {
    text: "Start your career in retail banking",
    icon: careerIcon,
    textClassName:
      "font-medium text-[18px] leading-[1] text-[rgba(250,250,250,1)]",
  },
  {
    text: "Earn a CTC of Rs. 3.1 LPA + incentives",
    icon: ctcIcon,
    textClassName:
...
export default function CareerGrowth() {
  ...
  return (
    <section
      id="career-growth"
      className="relative bg-[rgba(143,40,44,0.1)] backdrop-blur-[100px] text-white scroll-mt-24 overflow-hidden"
    >
      <div
        aria-hidden="true"
      ...
      <div className="relative z-10 px-4 sm:px-6 md:px-8 py-section lg:pl-[120px] lg:pr-0 lg:pt-[110px] lg:pb-[110px]">
        <div className="career-growth-card w-full flex flex-col items-start gap-24 lg:flex-row lg:items-stretch lg:justify-between lg:gap-x-12 rounded-[16px] bg-[rgba(10,49,82,0.2)]/0">
          {/* Left content */}
          <div className="w-full shrink-0 lg:w-[430px] lg:max-w-[430px]">
            ...
            <div className="mt-3 sm:mt-4">
              <p className="career-growth-subtitle text-lg sm:text-xl lg:text-2xl font-medium text-white text-justify leading-tight">
                From your first field sales role to bigger opportunities.
              </p>
              <p className="career-growth-body mt-3 sm:mt-4 font-normal text-[16px] leading-[24px] text-[rgba(250,250,250,0.8)] text-justify">
                Designed as a strong entry point with a clear path to grow within the retail banking industry.
              </p>
            </div>
