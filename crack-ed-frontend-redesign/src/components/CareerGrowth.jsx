...
const CAREER_STAGES = [
  {
    title: "Gold Assayer",
    description:
      "Evaluate gold ornaments, support loan processing, and assist customers with accurate and secure gold loan services.",
  },
  {
    title: "Senior Gold Assayer",
    description:
      "Handle complex gold valuations, ensure compliance and accuracy, and support branch gold loan operations.",
  },
  {
    title: "Branch Gold Manager",
    description:
      "Oversee branch gold loan activities, manage teams, and drive customer service and business performance.",
  },
  {
    title: "Area Gold Manager",
    description:
      "Lead gold loan operations across multiple branches, guide teams, and drive portfolio growth and operational excellence.",
  },
];

const LINE_ANGLE_DEG = 59.1;
const ACTIVE_ACCENT = "rgba(10, 49, 82, 1)";
    ...
    >
      ...
      <div className="relative z-10 px-4 sm:px-6 md:px-8 py-section lg:pl-[120px] lg:pr-0 lg:pt-[110px] lg:pb-[110px]">
        <div className="career-growth-card w-full flex flex-col lg:flex-row gap-8 lg:gap-12 rounded-[16px] bg-[rgba(10,49,82,0.2)]/0">
          ...
          <div className="w-full lg:w-[430px] flex-shrink-0">
            ...
            <div className="mt-3 sm:mt-4">
              <p className="career-growth-subtitle text-lg sm:text-xl lg:text-2xl font-medium text-white text-justify leading-tight">
                From your first role in gold finance to bigger opportunities.
              </p>
              <p className="career-growth-body mt-3 sm:mt-4 font-normal text-[16px] leading-[24px] text-[rgba(250,250,250,0.8)] text-justify">
                Designed as a strong entry point with clear scope to grow into senior branch responsibilities.
              </p>
            </div>
            ...
            <div className="mt-3 sm:mt-4 space-y-0">
              {[
                {
                  text: "Start your career in the gold finance industry",
                  icon: careerIcon,
                  textClassName:
                    "font-medium text-[18px] leading-[1] text-[rgba(250,250,250,1)]",
                },
                {
                  text: "Earn a CTC of upto Rs. 2.5 LPA + incentives",
                  icon: ctcIcon,
                  textClassName:
                    "font-medium text-[18px] leading-[27px] text-[rgba(250,250,250,1)]",
                },
                {
                  text: "Grow into senior roles within gold lending and branch operations",
                  icon: growthIcon,
                  textClassName:
                    "font-medium text-[18px] leading-[1] text-[rgba(250,250,250,1)]",
                  alignBottomDot: true,
          ...
          {/* Career roadmap */}
          <div className="career-growth-image-wrap flex-1 flex justify-center lg:justify-end min-w-0 mx-0">
            <div
              ref={roadmapRef}
              className="career-roadmap relative min-w-0 w-full flex-1 pr-4 sm:pr-2 lg:pr-0 overflow-visible lg:overflow-hidden lg:min-h-full"
            ...
            >
              ...
              {isDesktopLayout ? (
                ...
                <div
                  className="flex flex-col pl-1 pr-2"
