...
const CAREER_STAGES = [
  {
    ...
    description:
      "Conduct eye tests, assist customers with accurate vision solutions, and support a seamless in-store clinical experience.",
  },
  {
    title: "Store Manager",
    description:
      "Oversee store operations, lead teams, and ensure exceptional customer service and sales performance.",
  },
  {
    title: "Area Operations Manager",
    description:
      "Manage operations across multiple stores, drive team performance, and ensure smooth customer and business operations.",
  },
  {
    title: "Zonal Manager",
    description:
      "Lead regional store networks, optimize operational performance, and drive business growth across zones.",
  },
  {
    title: "Business Head",
    description:
      "Oversee large-scale business strategy, operations, and growth initiatives while leading high-performing teams across regions.",
  },
];
