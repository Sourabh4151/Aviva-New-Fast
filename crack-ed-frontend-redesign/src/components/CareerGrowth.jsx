...
const CAREER_STAGES = [
  {
    title: "Credit & Operations Executive",
    description:
      "Start your career by developing expertise in loan documentation, verification, and credit operations.",
  },
  {
    title: "Credit & Operations Manager",
    description:
      "Manage critical lending processes and play a key role in ensuring accurate, compliant, and timely loan approvals.",
  },
  {
    title: "Senior Credit Manager",
    description:
      "Lead high-impact credit decisions, drive operational excellence, and shape the future of lending within the organization.",
  },
];
