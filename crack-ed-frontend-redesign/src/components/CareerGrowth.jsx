...
const ACTIVE_ACCENT = "rgba(239, 65, 35, 1)";
...
export default function CareerGrowth() {
  ...
  return (
    <section
      ref={sectionRef}
      id="career-growth"
      className="relative bg-[rgba(239,65,36,0.08)] backdrop-blur-[100px] text-white scroll-mt-24 overflow-hidden"
    >
          ...
          <div className="w-full lg:w-[430px] flex-shrink-0">
            ...
            <div className="mt-3 sm:mt-4">
              <p className="career-growth-subtitle text-lg sm:text-xl lg:text-2xl font-medium text-white text-justify leading-tight">
                From your first role in home loan to bigger opportunities.
              </p>
            ...
            <div className="mt-3 sm:mt-4 space-y-0">
              {[
                {
                  text: "Start your career in the housing finance",
                  icon: careerIcon,
                  textClassName:
