...
const CAREER_STAGES = [
  {
    ...
    description:
      "Assist customers in choosing the right eyewear, manage in-store sales, and deliver a seamless customer experience.",
  },
  {
    title: "Senior Retail Sales Associate",
    description:
      "Handle customer relationships, support store operations, and drive sales performance through personalized service.",
  },
  {
    title: "Store Manager",
    description:
      "Lead store operations, manage teams, and ensure excellent customer experience and business performance.",
  },
  {
    title: "Area Operations Manager",
    description:
      "Oversee operations across multiple stores, guide teams, and drive operational efficiency and sales growth.",
  },
  {
    title: "Zonal Manager",
    description:
      "Manage regional store performance, lead large teams, and drive business growth and operational excellence across zones.",
  },
];

const LINE_ANGLE_DEG = 59.1;
const ACTIVE_ACCENT = "rgba(3, 0, 69, 1)";
