...
const CAREER_STAGES = [
  {
    ...
    description:
      "Engage with customers, promote consumer finance solutions, and support loan processing at retail and dealer locations.",
  },
  {
    title: "Senior Sales Executive",
    description:
      "Manage customer relationships, drive financing sales growth, and ensure smooth onboarding and service delivery.",
  },
  {
    title: "Relationship Officer",
    description:
      "Build long-term customer and dealer relationships while supporting loan sales and portfolio management.",
  },
  {
    title: "Area Sales Manager",
    description:
      "Lead regional sales teams, oversee business performance, and drive expansion of consumer finance solutions across multiple locations.",
  },
];
          ...
          <div className="w-full lg:w-[430px] flex-shrink-0">
            ...
            <div className="mt-3 sm:mt-4 space-y-0">
              {[
                ...
                {
                  text: "Earn a CTC of upto Rs. 2.76 LPA + incentives",
                  icon: ctcIcon,
                  textClassName:
