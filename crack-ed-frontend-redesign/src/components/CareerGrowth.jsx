...
const CAREER_STAGES = [
  {
    ...
    description:
      "Drives business through dealer networks, customer acquisition, and channel partnerships in used car finance.",
  },
  {
    title: "Senior Business Manager",
    description:
      "Expands territory performance, deepens dealer relationships, and leads higher-value business sourcing.",
  },
  {
    title: "Area Sales Manager",
    description:
      "Manages multiple locations, oversees sales execution, and ensures consistent performance across assigned areas.",
  },
  {
    title: "Regional Sales Manager",
    description:
      "Leads regional growth strategy, drives large-scale business targets, and mentors sales leadership teams.",
  },
];

const LINE_ANGLE_DEG = 59.1;
const ACTIVE_ACCENT = "rgba(87, 190, 136, 1)";
    ...
    >
      ...
      <span
        ...
        style={{
          ...
          ...(isActive ? { color: "rgba(30, 30, 30, 1)" } : {}),
...
export default function CareerGrowth() {
  ...
  return (
    <section
      ...
      style={{ backgroundColor: "rgba(9, 19, 14, 1)" }}
    >
      <div
        aria-hidden="true"
        ...
        <div className="career-growth-card w-full flex flex-col lg:flex-row gap-8 lg:gap-12 rounded-[16px] bg-[rgba(10,49,82,0.2)]/0">
          ...
          <div className="w-full lg:w-[430px] flex-shrink-0">
            ...
            <div className="mt-3 sm:mt-4">
              ...
              From your first field sales role to bigger opportunities in automotive finance.
              </p>
              <p className="career-growth-body mt-3 sm:mt-4 font-normal text-[16px] leading-[24px] text-[rgba(250,250,250,0.8)] text-justify">
              Designed as a strong entry point with a clear path to grow within the auto finance industry.
              </p>
            </div>
            ...
            <div className="mt-3 sm:mt-4 space-y-0">
              {[
                {
                  text: "Start your career in used car finance",
                  icon: careerIcon,
                  textClassName:
