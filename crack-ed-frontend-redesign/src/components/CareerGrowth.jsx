...
const CAREER_STAGES = [
  {
    ...
    description:
      "Handle customer transactions, manage cash operations accurately, and deliver a smooth banking experience.",
  },
  {
    title: "Senior Cashier / Teller",
    description:
      "Oversee daily cash operations, support branch transaction activities, and ensure accuracy and compliance.",
  },
  {
    title: "Assistant Manager – Cash Operations",
    description:
      "Manage branch cash processes, supervise operational activities, and ensure efficient customer service delivery.",
  },
  {
    title: "Deputy Manager",
    description:
      "Lead branch operations teams, streamline banking processes, and drive operational efficiency and customer satisfaction.",
  },
];
          ...
          <div className="w-full lg:w-[430px] flex-shrink-0">
            ...
            <div className="mt-3 sm:mt-4">
              ...
              <p className="career-growth-body mt-3 sm:mt-4 font-normal text-[16px] leading-[24px] text-[rgba(250,250,250,0.8)] text-justify">
                Designed as a strong entry point with clear scope to grow into senior branch
                responsibilities.
              </p>
            </div>
            ...
            <div className="mt-3 sm:mt-4 space-y-0">
              {[
                ...
                {
                  text: "Earn a CTC of upto Rs. 3.5 LPA",
                  icon: ctcIcon,
                  textClassName:
