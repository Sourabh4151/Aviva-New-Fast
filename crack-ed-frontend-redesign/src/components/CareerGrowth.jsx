...
const CAREER_STAGES = [
  {
    ...
    description:
      "Connect with MSME customers, support secured lending processes, and build strong customer relationships through field engagement.",
  },
  {
    title: "Senior Relationship Officer",
    description:
      "Manage customer portfolios, strengthen client relationships, and drive secured lending business growth.",
  },
  {
    title: "Relationship Manager",
    description:
      "Handle MSME client relationships, provide tailored financial solutions, and support portfolio expansion and customer retention.",
  },
  {
    title: "Branch Manager",
    description:
      "Lead branch operations, oversee lending and customer acquisition activities, and drive overall business growth and team performance.",
  },
];

const LINE_ANGLE_DEG = 59.1;
const ACTIVE_ACCENT = "rgba(151, 20, 77, 1)";
...
export default function CareerGrowth() {
  ...
  return (
    <section
      ref={sectionRef}
      id="career-growth"
      className="relative bg-[rgba(166,26,86,0.1)] backdrop-blur-[100px] text-white scroll-mt-24 overflow-hidden"
    >
      <div
        aria-hidden="true"
      ...
      <div className="relative z-10 px-4 sm:px-6 md:px-8 py-section lg:pl-[120px] lg:pr-0 lg:pt-[110px] lg:pb-[110px]">
        <div className="career-growth-card w-full flex flex-col lg:flex-row gap-8 lg:gap-12 rounded-[16px] bg-[rgba(10,49,82,0.2)]/0">
          ...
          <div className="mt-3 sm:mt-4">
            ...
            From your first lending role to bigger opportunities.
            </p>
            <p
              className="career-growth-body mt-3 sm:mt-4 font-normal text-[16px] leading-[24px] text-[rgba(250,250,250,0.8)] text-justify"
            >
              Designed as a strong entry point with clear scope to grow into leadership responsibilities.
            </p>
          </div>
          ...
          <div className="mt-3 sm:mt-4 space-y-0">
            {[
              {
                text: "Start your career in MSME lending",
                icon: careerIcon,
                textClassName:
                  "font-medium text-[18px] leading-[1] text-[rgba(250,250,250,1)]",
              },
              {
                text: "Earn a CTC of Rs 2.4 LPA  + Incentives upto Rs 1 LPA",
                icon: ctcIcon,
                textClassName:
                  "font-medium text-[18px] leading-[27px] text-[rgba(250,250,250,1)]",
              },
              {
                text: "Grow into senior sales and lending roles",
                icon: growthIcon,
                textClassName:
                  "font-medium text-[18px] leading-[1] text-[rgba(250,250,250,1)]",
                alignBottomDot: true,
