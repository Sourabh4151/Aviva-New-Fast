...
const CAREER_STAGES = [
  {
    ...
    description:
      "Build customer relationships and help grow the bank's customer base through sales and account acquisition",
  },
  {
    title: "Senior Sales Executive",
    description:
      "Lead customer acquisition efforts, drive sales performance, and manage key client relationships for business growth.",
  },
  {
    title: "Assistant Sales Manager",
    description:
      "Support sales team performance, drive business growth, and help manage customer acquisition strategies.",
  },
  {
    title: "Sales Manager",
    description:
      "Lead sales teams, drive business targets, and build strategies to grow customer acquisition and revenue.",
  },
];
...
const STAGE_BLOCK_GAP_PX = 72;
const TOP_STAGE_MIN_PX = 8;
const MOBILE_STAGE_GAP_PX = 40;

const FEATURES = [
  {
    text: "Start your career in the banking industry",
    icon: careerIcon,
  },
  {
    text: "Earn a CTC of Rs 2.5 LPA + incentives",
    icon: ctcIcon,
  },
  {
          ...
          <div className="w-full flex-shrink-0 lg:w-[430px]">
            ...
            <div className="mt-3 sm:mt-4">
              ...
              <p className="career-growth-body mt-3 font-normal text-[16px] leading-[24px] text-[rgba(250,250,250,0.8)] text-justify sm:mt-4">
                Designed as a strong entry point with a clear path to grow
                within the finance industry.
              </p>
            </div>

            <div className="mt-3 space-y-0 sm:mt-4">
              {FEATURES.map(({ text, icon, alignBottomDot }) => (
                <div
                  key={text}
                ...
                >
                  <img
                    ...
                    aria-hidden="true"
                  />
                  <p className="career-growth-list-text text-base font-medium leading-snug text-[rgba(250,250,250,1)] sm:text-[18px]">
                    {text}
                  </p>
                </div>
              ))}
