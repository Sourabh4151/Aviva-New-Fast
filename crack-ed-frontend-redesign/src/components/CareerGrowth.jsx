...
const CAREER_STAGES = [
  {
    ...
    description:
      "Identify customers, build relationships, and support loan sourcing, onboarding, and repayments in rural markets.",
  },
  {
    title: "Senior Field Executive",
    description:
      "Manage a larger customer base, drive renewals and referrals, and strengthen portfolio performance.",
  },
  {
    title: "Branch Manager",
    description:
      "Lead branch operations, manage team performance, and ensure business growth and portfolio quality.",
  },
  {
    title: "Regional Operations Manager",
    description:
      "Oversee multiple branches, drive regional performance, and ensure operational efficiency and growth.",
  },
];

const LINE_ANGLE_DEG = 59.1;
const ACTIVE_ACCENT = "rgba(3, 149, 218, 1)";
...
export default function CareerGrowth() {
  ...
  return (
    <section
      ref={sectionRef}
      id="career-growth"
      className="relative bg-[rgba(0,15,22,1)] text-white scroll-mt-24 overflow-hidden"
    >
      <div
        aria-hidden="true"
        ...
        <div className="career-growth-card w-full flex flex-col lg:flex-row gap-8 lg:gap-12 rounded-[16px] bg-[rgba(10,49,82,0.2)]/0">
          ...
          <div className="w-full lg:w-[430px] flex-shrink-0">
            ...
            <div className="mt-3 sm:mt-4">
              ...
              From your first role in rural banking to bigger opportunities.
              </p>
              <p className="career-growth-body mt-3 sm:mt-4 font-normal text-[16px] leading-[24px] text-[rgba(250,250,250,0.8)] text-justify">
              Designed as a strong entry point with a clear path to grow within rural banking and financial inclusion.
              </p>
            </div>
            ...
            <div className="mt-3 sm:mt-4 space-y-0">
              {[
                {
                  text: "Start your career in field banking and relationship management",
                  icon: careerIcon,
                  textClassName:
                    "font-medium text-[18px] leading-[1] text-[rgba(250,250,250,1)]",
                },
                {
                  text: "Earn a CTC of up to Rs. 2.22 LPA + incentives",
                  icon: ctcIcon,
                  textClassName:
