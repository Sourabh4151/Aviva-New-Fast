...
const CAREER_STAGES = [
  {
    title: "Front Line Sales Executive",
    description:
      "Connect with customers, explain life insurance solutions, and drive customer acquisition through field sales activities.",
  },
  {
    title: "Senior Front Line Sales Executive",
    description:
      "Manage customer relationships, support complex sales conversations, and contribute to business growth through tailored insurance solutions.",
  },
  {
    title: "Front Line Sales Assistant Manager",
    description:
      "Lead frontline sales activities, guide teams, and ensure strong customer engagement and sales performance.",
  },
  {
    title: "Front Line Sales Deputy Manager",
    description:
      "Oversee sales teams, drive regional business targets, and ensure high performance, compliance, and customer satisfaction.",
  },
];

const LINE_ANGLE_DEG = 59.1;
const ACTIVE_ACCENT = "rgba(255, 217, 0, 1)";
...
export default function CareerGrowth() {
  ...
  return (
    <section
      ref={sectionRef}
      id="career-growth"
      className="relative bg-[rgba(255,217,0,0.05)] backdrop-blur-[100px] text-white scroll-mt-24 overflow-hidden"
    >
      <div
        aria-hidden="true"
          ...
          <div className="w-full lg:w-[430px] flex-shrink-0">
            ...
            <div className="mt-3 sm:mt-4">
              <p className="career-growth-subtitle text-lg sm:text-xl lg:text-2xl font-medium text-white text-justify leading-tight">
                From your first sale to bigger opportunities.
              </p>
              <p className="career-growth-body mt-3 sm:mt-4 font-normal text-[16px] leading-[24px] text-[rgba(250,250,250,0.8)] text-justify">
                Designed as a strong entry point with clear scope to grow into senior sales responsibilities.
              </p>
            </div>
