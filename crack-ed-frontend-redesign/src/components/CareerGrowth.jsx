...
const CAREER_STAGES = [
  {
    ...
    description:
      "Onboard merchants, promote digital payment solutions, and build strong relationships with business owners.",
  },
  {
    title: "Assistant Manager",
    description:
      "Support sales operations, manage merchant relationships, and drive adoption of digital payment services across assigned markets.",
  },
  {
    title: "Team Manager",
    description:
      "Lead field sales teams, oversee merchant acquisition performance, and drive business growth and operational efficiency.",
  },
];

const LINE_ANGLE_DEG = 59.1;
const ACTIVE_ACCENT = "rgba(0, 188, 241, 1)";
          ...
          <div className="w-full lg:w-[430px] flex-shrink-0">
            ...
            <div className="mt-3 sm:mt-4">
              <p className="career-growth-subtitle text-lg sm:text-xl lg:text-2xl font-medium text-white text-justify leading-tight">
                From your first role in digital payments sales loan bigger opportunities.
              </p>
              <p className="career-growth-body mt-3 sm:mt-4 font-normal text-[16px] leading-[24px] text-[rgba(250,250,250,0.8)] text-justify">
                Designed as a strong entry point with a clear path to grow within the fintech finance industry.
              </p>
            </div>
            ...
            <div className="mt-3 sm:mt-4 space-y-0">
              {[
                {
                  text: "Start your career in the fintech finance",
                  icon: careerIcon,
                  textClassName:
                    "font-medium text-[18px] leading-[1] text-[rgba(250,250,250,1)]",
                },
                {
                  text: "Earn a CTC of ₹2.5 LPA + incentives",
                  icon: ctcIcon,
                  textClassName:
                    "font-medium text-[18px] leading-[27px] text-[rgba(250,250,250,1)]",
                },
                {
                  text: "Grow into senior sales and leadership roles",
                  icon: growthIcon,
                  textClassName:
                    "font-medium text-[18px] leading-[1] text-[rgba(250,250,250,1)]",
                  alignBottomDot: true,
