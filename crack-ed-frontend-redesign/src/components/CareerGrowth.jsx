...
const CAREER_STAGES = [
  {
    ...
    description:
      "Build expertise in customer engagement, repayment resolution, and field collections while managing assigned accounts and supporting portfolio health.",
  },
  {
    title: "Senior Collection Officer",
    description:
      "Take ownership of larger and more complex portfolios, handle escalated recovery cases, and mentor junior team members to improve collection outcomes.",
  },
  {
    title: "Collection Manager",
    description:
      "Lead collection teams, drive recovery strategy, monitor portfolio performance, and ensure business targets are achieved through effective people and process management.",
  },
];

const LINE_ANGLE_DEG = 59.1;
const ACTIVE_ACCENT = "rgba(58, 45, 125, 1)";
...
export default function CareerGrowth() {
  ...
  return (
    <section
      ref={sectionRef}
      id="career-growth"
      className="relative bg-[rgba(58,45,125,0.1)] backdrop-blur-[100px] text-white scroll-mt-24 overflow-hidden"
    >
      <div
        aria-hidden="true"
          ...
          <div className="w-full lg:w-[430px] flex-shrink-0">
            ...
            <div className="mt-3 sm:mt-4">
              ...
              <p className="career-growth-body mt-3 sm:mt-4 font-normal text-[16px] leading-[24px] text-[rgba(250,250,250,0.8)] text-justify">
                Designed as a strong entry point with a clear path to grow within the housing finance industry.
              </p>
            </div>
            ...
            <div className="mt-3 sm:mt-4 space-y-0">
              {[
                {
                  text: "Start your career in housing finance",
                  icon: careerIcon,
                  textClassName:
                    "font-medium text-[18px] leading-[1] text-[rgba(250,250,250,1)]",
                },
                {
                  text: "Earn a CTC of Rs 5 LPA + incentives",
                  icon: ctcIcon,
                  textClassName:
