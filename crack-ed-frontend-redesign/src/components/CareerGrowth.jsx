...
const CAREER_STAGES = [
  {
    ...
    description:
      "Recruit advisors, build strong agency relationships, and drive life insurance sales through the agency channel.",
  },
  {
    title: "Senior Agency Sales Executive",
    description:
      "Manage advisor performance, strengthen agency networks, and contribute to business growth through quality sales.",
  },
  {
    title: "Agency Sales Assistant Manager",
    description:
      "Lead agency sales activities, support advisor development, and drive team performance and target achievement.",
  },
  {
    title: "Agency Sales Deputy Manager",
    description:
      "Oversee agency sales teams, manage large advisor networks, and drive business expansion and operational performance.",
  },
];
