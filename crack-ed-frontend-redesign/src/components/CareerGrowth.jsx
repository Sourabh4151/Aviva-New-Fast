        ...
        <div className="career-growth-card w-full flex flex-col lg:flex-row gap-8 lg:gap-12 rounded-[16px] bg-[rgba(10,49,82,0.2)]/0">
          ...
          <div className="w-full lg:w-[430px] flex-shrink-0">
            ...
            <div className="mt-3 sm:mt-4">
              ...
              The role prepares you to ace industry awareness and sales readiness while also preparing you to excel in your organization's context.
              </p>
            </div>
            ...
            <div className="mt-3 sm:mt-4 space-y-0">
              {[
                {
                  text: "Prepare for a career in EdTech, not just your first job",
                  icon: careerIcon,
                  textClassName:
                    "font-medium text-[18px] leading-[1] text-[rgba(250,250,250,1)]",
                },
                {
                  text: "Get promoted to Team Lead within 6 months based on performance",
                  icon: growthIcon,
                  textClassName:
                    "font-medium text-[18px] leading-[27px] text-[rgba(250,250,250,1)]",
                },
                {
                  text: "Gain skills that are transferable across industries",
                  icon: ctcIcon,
                  textClassName:
                    "font-medium text-[18px] leading-[1] text-[rgba(250,250,250,1)]",
                  alignBottomDot: true,
