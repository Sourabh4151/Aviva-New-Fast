...
const CAREER_STAGES = [
  {
    title: "Associate",
    description:
      "Build strong customer relationships and deliver trusted financial solutions.",
  },
  {
    title: "Assistant Manager",
    description:
      "Drive business growth while mentoring and supporting branch operations.",
  },
  {
    title: "Deputy Manager",
    description:
      "Ensure smooth branch operations with operational excellence.",
  },
  {
    title: "Manager",
    description:
      "Lead teams, enhance performance, and deliver exceptional customer service.",
  },
];

const LINE_ANGLE_DEG = 59.1;
const ACTIVE_ACCENT = "rgba(228, 19, 37, 1)";
...
const DURATION_LABEL_TEXT = "18 months#";

const DURATION_LABEL_ABOVE_OFFSET_PX = 16;

function getDurationLabelStyle(connectorLine, isDesktop) {
  const start = connectorLine?.dotCenters?.[0];
  const end = connectorLine?.dotCenters?.[1];
    ...
    >
      ...
      <span
        ...
        style={{
          ...
          ...(isActive ? { color: "rgba(250, 250, 250, 1)" } : {}),
...
export default function CareerGrowth() {
  ...
  return (
    <section
      ...
      style={{ backgroundColor: "rgba(24, 3, 4, 1)" }}
    >
      <div
        aria-hidden="true"
      ...
      <div className="relative z-10 px-4 sm:px-6 md:px-8 py-section lg:pl-[120px] lg:pr-0 lg:pt-[110px] lg:pb-[110px]">
        <div className="career-growth-card w-full flex flex-col lg:flex-row gap-8 lg:gap-12 rounded-[16px] bg-[rgba(10,49,82,0.2)]/0">
          ...
          <div className="w-full lg:w-[430px] flex-shrink-0">
            ...
            <div className="mt-3 sm:mt-4">
              ...
              Build a rewarding career in banking with clear opportunities to grow.
              </p>
              <p className="career-growth-body mt-3 sm:mt-4 font-normal text-[16px] leading-[24px] text-[rgba(250,250,250,0.8)] text-justify">
              Designed as a strong entry point with a clear path to grow within the gold loan industry.
              </p>
            </div>
            ...
            <div className="mt-3 sm:mt-4 space-y-0">
              {[
                {
                  text: "Start your career in gold loans",
                  icon: careerIcon,
                  textClassName:
                    "font-medium text-[18px] leading-[1] text-[rgba(250,250,250,1)]",
                },
                {
                  text: "Earn a CTC of ₹3 LPA (Fixed)+ Performance Linked Pay*",
                  icon: ctcIcon,
                  textClassName:
                    "font-medium text-[18px] leading-[27px] text-[rgba(250,250,250,1)]",
                },
                {
                  text: "Grow into senior and leadership roles",
                  icon: growthIcon,
                  textClassName:
                    "font-medium text-[18px] leading-[1] text-[rgba(250,250,250,1)]",
                  alignBottomDot: true,
        ...
        <p className="career-growth-disclaimer mt-6 w-full max-w-[1040px] lg:mt-8">
          #Terms and conditions apply. After completion of 18 months and on the
          basis of internal progression, the candidate will be eligible for
          Designation: Assistant Manager (AM), (Full Term Employment)
        </p>
      </div>
    </section>
  );
