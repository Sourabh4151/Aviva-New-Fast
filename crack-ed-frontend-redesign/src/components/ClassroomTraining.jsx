...
const MODULES = [
  {
    ...
    description:
      "Build a strong base in the BFSI ecosystem, regulatory understanding under the Reserve Bank of India, and credit awareness through systems like CIBIL. Also develop professional behaviour and communication skills essential for the banking environment.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
    "Strengthen technical expertise in home loans, credit evaluation, and complete loan processing, enabling you to assess risk and manage cases with clarity and confidence.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "Sharpen sales strategy, customer engagement, and market execution skills, preparing you to confidently drive performance and business growth.",
    image: shikharImg,
  },
];
