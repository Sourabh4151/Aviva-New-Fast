...
const MODULES = [
  {
    ...
    description:
      "Utthaan introduces candidates to the BFSI sector, NBFCs, and the fundamentals of lending. Through workshops and practical exercises, candidates develop communication skills, professional behavior, and the ability to engage effectively with customers.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
      "Aarohan focuses on home loans and the credit appraisal process. Candidates learn to assess customer needs, evaluate documentation, and understand technical and legal aspects of lending through case studies, role-plays, and hands-on exercises.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "Shikhar enhances sales and field skills. Candidates gain expertise in pitching, objection handling, customer engagement, and channel management, while also learning cross-selling, upselling, and practical sales techniques through workshops, labs, and site visits.",
    image: shikharImg,
  },
];
