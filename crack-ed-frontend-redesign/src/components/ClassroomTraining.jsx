...
const MODULES = [
  {
    ...
    description:
      "Utthan builds the foundation for a career in vision care. In this phase, learners are introduced to healthcare systems, eye anatomy, vision basics, and the role of a clinical professional. The focus is on understanding how eye care works, learning basic vision assessment concepts, and building essential communication and patient interaction skills.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
      "Aarohan focuses on developing deeper clinical knowledge and practical understanding. Learners explore optics, refractive errors, lenses, and contact lenses while learning important processes like patient history taking, measuring vitals, and vision assessment techniques. This phase helps connect theoretical learning with real-world eye care practices.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    label: "Shikhar",
    heading: "Professional Readiness",
    description:
      "Shikhar prepares learners to confidently step into real clinical environments. The focus shifts to hands-on practice in eye testing, ophthalmic dispensing, and professional patient handling. Alongside advanced communication and workplace professionalism, this phase ensures learners are ready to perform effectively in a vision care setting.",
    image: shikharImg,
  },
];
              ...
              >
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 items-stretch">
                  <div className="order-2 lg:order-1 flex-1 rounded-[10px] bg-black/20 px-4 sm:px-6 lg:px-8 py-6 lg:py-8 max-w-full lg:max-w-[512px]">
                    <div
                      ...
                      style={{
                        borderRadius: 100,
                        border: "1px solid rgba(3, 0, 69, 1)",
                        backgroundColor: "rgba(3, 0, 69, 1)",
                        paddingTop: 4,
                        paddingBottom: 4,
                        paddingLeft: 30,
                ...
                {index === MODULES.length - 1 && (
                  <div className="mt-6 sm:mt-8 flex justify-center sm:justify-start">
                    <a
                      href="/Lenskart%20CT.pdf"
                      download="Lenskart - CT.pdf"
