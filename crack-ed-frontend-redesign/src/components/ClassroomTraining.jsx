...
const MODULES = [
  {
    ...
    description:
      "Candidates build a strong foundation by understanding the banking industry, the CASA sales role, and the professional behaviour expected in a sales career. They also develop essential communication skills and learn to present themselves confidently in interviews and customer interactions.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
      "Candidates gain working knowledge of the organization and its key liability products, and understand how CASA acquisition works in a field sales environment. This phase prepares them to speak confidently about the organization, the role, and the products during interviews.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "Candidates undergo intensive interview preparation and simulated interviews, receiving feedback to improve articulation, confidence, and sales intent. This phase ensures they are fully prepared to succeed in the final interview with the hiring organization.",
    image: shikharImg,
  },
];
                ...
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 items-stretch">
                  <div className="order-2 lg:order-1 flex-1 rounded-[10px] bg-black/20 px-4 sm:px-6 lg:px-8 py-6 lg:py-8 max-w-full lg:max-w-[512px]">
                    <div
                      ...
                      style={{
                        borderRadius: 100,
                        border: "1px solid rgba(143, 40, 44, 1)",
                        backgroundColor: "rgba(143, 40, 44, 1)",
                        paddingTop: 4,
                        paddingBottom: 4,
                        paddingLeft: 30,
