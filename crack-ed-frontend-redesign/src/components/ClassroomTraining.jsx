...
const MODULES = [
  {
    ...
    description:
      "Utthaan builds the foundation for a career in banking by introducing learners to the organization, the branch environment, and professional workplace expectations. The phase focuses on essential communication skills such as active listening, rapport building, and professional digital communication, while roleplays and a bank visit help candidates begin practicing customer interactions.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
      "Aarohan strengthens learners’ understanding of banking products, processes, and terminology. Candidates learn about different account types, cards, deposits, and third-party products, along with operational processes such as cash handling and form documentation. Practical exercises and product pitch roleplays help build confidence in explaining banking solutions to customers.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "Shikhar focuses on applying service and sales skills in real customer scenarios. Learners develop the ability to handle customer interactions effectively, manage service situations, and identify cross-selling opportunities at the branch and cash counter. Roleplays and de-escalation techniques help candidates deliver strong customer service while supporting business goals.",
    image: shikharImg,
  },
];
              ...
              >
                ...
                {index === MODULES.length - 1 && (
                  <div className="mt-6 sm:mt-8 flex justify-center sm:justify-start">
                    <a
                      href="/UCP%20Teller.pdf"
                      download="UCP Teller.pdf"
