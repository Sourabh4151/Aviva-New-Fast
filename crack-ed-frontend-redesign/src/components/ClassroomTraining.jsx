...
const MODULES = [
  {
    ...
    description:
      "Utthaan introduces you to the world of housing finance and credit operations, helping you understand the lending lifecycle, key products, and the role of credit and operations teams. You build a strong foundation in industry knowledge, loan processes, documentation requirements, and the professional standards expected in the role.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
      "Aarohan focuses on the practical skills required to perform effectively in credit and operations. Through real-world scenarios, process walkthroughs, and guided practice, you learn document verification, compliance checks, stakeholder coordination, and the operational workflows that ensure loans move smoothly from application to disbursement.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "Shikhar helps you transition from learner to practitioner by bringing together everything you've learned into job-ready performance. You refine your decision-making, problem-solving, and operational ownership through assessments, simulations, and industry-aligned projects, building the confidence to contribute from day one as a Credit & Operations professional.",
    image: shikharImg,
  },
];
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  backgroundColor: "rgba(58, 45, 125, 1)",
                }}
              />
                ...
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 items-stretch">
                  <div className="order-2 lg:order-1 flex-1 rounded-[10px] bg-black/20 px-4 sm:px-6 lg:px-8 py-6 lg:py-8 max-w-full lg:max-w-[512px]">
                    <div
                      ...
                      style={{
                        borderRadius: 100,
                        border: "1px solid rgba(58, 45, 125, 1)",
                        backgroundColor: "rgba(58, 45, 125, 1)",
                        paddingTop: 4,
                        paddingBottom: 4,
                        paddingLeft: 30,
