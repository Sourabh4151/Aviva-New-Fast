...
const MODULES = [
  {
    ...
    description:
      "In Utthaan, you get introduced to the retail world and learn what it’s like to work in a store. You’ll understand the role of a sales associate, how stores run, and what customers expect. You’ll also build basic skills like communication, confidence, personal grooming, and simple math needed for everyday store tasks.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
      "Aarohan focuses on product knowledge and understanding customer needs. You’ll learn about different types of eyewear, lenses, frames, and accessories. You’ll practice how to figure out what a customer wants, suggest the right products, and even try simple upselling and cross-selling in a helpful way.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "Shikhar is all about putting your skills into action. You’ll practice greeting customers, having full sales conversations, handling objections, and closing sales confidently. This phase helps you get comfortable interacting with real customers and becoming a confident sales associate.",
    image: shikharImg,
  },
];
              ...
              >
                ...
                {index === MODULES.length - 1 && (
                  <div className="mt-6 sm:mt-8 flex justify-center sm:justify-start">
                    <a
                      href="/Lenskart%20RSA.pdf"
                      download="Lenskart - RSA.pdf"
