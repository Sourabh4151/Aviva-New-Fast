...
const MODULES = [
  {
    ...
    description:
      "Utthaan is the foundation stage of the program where candidates build the right mindset and professional basics for a sales career. Candidates are introduced to workplace expectations, communication fundamentals, and personal presentation in a professional environment. Through activities like elevator pitches, active listening exercises, and mock interviews, this phase helps candidates develop confidence and prepare for real interview situations.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    label: "Aarohan",
    heading: "Strengthening Communication & Confidence",
    description:
      "Aarohan focuses on strengthening communication and developing the skills required to succeed in customer-facing roles. Candidates learn how to present themselves effectively, communicate with clarity, and build strong interpersonal skills. With guided workshops and mock interviews, this phase helps candidates practice speaking with confidence and prepares them to engage professionally with customers and colleagues.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    label: "Shikhar",
    heading: "Mastering Product Knowledge & Sales Readiness",
    description:
      "Shikhar is the advanced stage where candidates gain a deeper understanding of the company and the sales ecosystem. This phase introduces them to Paytm’s products, services, and value proposition, along with insights into the competitive landscape. Through hands-on practice and pitching exercises, candidates learn how to confidently explain Paytm solutions to merchants and perform effectively in final interview assessments.",
    image: shikharImg,
  },
];
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  backgroundColor: "rgba(0, 185, 237, 1)",
                }}
              />
              ...
              >
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 items-stretch">
                  <div className="order-2 lg:order-1 flex-1 rounded-[10px] bg-black/20 px-4 sm:px-6 lg:px-8 py-6 lg:py-8 max-w-full lg:max-w-[512px]">
                    <div
                      ...
                      style={{
                        borderRadius: 100,
                        border: "1px solid rgba(0, 185, 237, 1)",
                        backgroundColor: "rgba(0, 185, 237, 1)",
                        paddingTop: 4,
                        paddingBottom: 4,
                        paddingLeft: 30,
                ...
                {index === MODULES.length - 1 && (
                  <div className="mt-6 sm:mt-8 flex justify-center sm:justify-start">
                    <a
                      href="/PDP%20Front%20Line%20Sales%20Executive.pdf"
                      download="PDP Front Line Sales Executive.pdf"
