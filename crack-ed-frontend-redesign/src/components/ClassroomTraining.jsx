...
const MODULES = [
  {
    ...
    description:
      "Utthaan builds the foundation for a career in the gold loan industry by introducing the BFSI sector, key banking terminology, and the role of gold loans in rural credit. It also develops basic professional skills such as communication, customer sensitivity, and numeracy required for branch operations.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    label: "Aarohan",
    heading: "Developing Technical Expertise",
    description:
      "Aarohan focuses on developing technical expertise in gold appraisal and valuation. Learners gain knowledge of metallurgy, purity systems, jewellery types, valuation tools, and regulatory guidelines to ensure accurate and compliant gold loan processing.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    label: "Shikhar",
    heading: "Applying Skills in Real Branch Scenarios",
    description:
      "Shikhar prepares learners to apply their knowledge in real branch scenarios by strengthening customer interaction, transparent communication, dispute handling, and fraud risk awareness while maintaining professionalism and trust.",
    image: shikharImg,
  },
];
              ...
              >
                ...
                {index === MODULES.length - 1 && (
                  <div className="mt-6 sm:mt-8 flex justify-center sm:justify-start">
                    <a
                      href="/Gold%20Assayer.pdf"
                      download="Gold Assayer.pdf"
