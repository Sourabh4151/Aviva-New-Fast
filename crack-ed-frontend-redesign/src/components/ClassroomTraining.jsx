...
const MODULES = [
  {
    ...
    description:
      "This module focuses on building a strong base by introducing candidates to the fundamentals of banking sales. Candidates develop clarity on the role of a field sales banking professional, core banking concepts, customer interaction basics, and essential communication skills required to operate confidently in real-world banking environments.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
      "Gain in-depth understanding of key banking products and processes, including liabilities, assets, CASA, and loan offerings. This module focuses on teaching how to align the right financial solutions to customer needs, handle queries effectively, and build structured conversations that support both service quality and sales outcomes.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "This final module prepares candidates for real-world performance through simulations, role-plays, and live scenario practice. The emphasis is on confidently managing end-to-end customer interactions, resolving challenges on the field, and delivering consistent sales performance with a professional and customer-first approach from day one.",
    image: shikharImg,
  },
];
