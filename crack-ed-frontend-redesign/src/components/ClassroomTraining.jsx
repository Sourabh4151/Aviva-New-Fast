...
const MODULES = [
  {
    ...
    description:
      "Utthaan lays the foundation for a career in secured lending. Candidates gain a clear understanding of the BFSI sector, how NBFC lending works, and the role they will play as Relationship Officers. The phase also helps participants build confidence in communicating with customers and understanding the mindset of borrowers in rural and semi-urban markets.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
      "Aarohan focuses on developing strong product understanding and the ability to explain loan solutions to customers with clarity. Candidates learn how loan products work in practice and how to communicate their value in simple, customer-friendly conversations.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "Shikhar prepares candidates to operate confidently in the field. The focus shifts to real sales situations — generating leads, addressing customer concerns, handling documentation, and supporting customers through the lending process from application to repayment.",
    image: shikharImg,
  },
];
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  backgroundColor: "rgba(169, 27, 88, 1)",
                }}
              />
              ...
              >
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 items-stretch">
                  <div className="order-2 lg:order-1 flex-1 rounded-[10px] bg-black/20 px-4 sm:px-6 lg:px-8 py-6 lg:py-8 max-w-full lg:max-w-[512px]">
                    <div
                      ...
                      style={{
                        borderRadius: 100,
                        border: "1px solid rgba(169, 27, 88, 1)",
                        backgroundColor: "rgba(169, 27, 88, 1)",
                        paddingTop: 4,
                        paddingBottom: 4,
                        paddingLeft: 30,
                ...
                {index === MODULES.length - 1 && (
                  <div className="mt-6 sm:mt-8 flex justify-center sm:justify-start">
                    <a
                      href="/VMP%20Relationship%20Officer.pdf"
                      download="VMP Relationship Officer.pdf"
