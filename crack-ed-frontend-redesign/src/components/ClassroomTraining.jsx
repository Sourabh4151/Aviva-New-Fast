...
const MODULES = [
  {
    ...
    description:
      "This phase lays the foundation for a career in lending and sales. Trainees are introduced to the lending industry, basic loan concepts, and the company’s values. It also focuses on building professional behaviour, communication skills, and the ability to start conversations with customers and introduce products confidently.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
      "This phase helps trainees build a deeper understanding of loan products and the lending process. They learn about product features, customer eligibility, required documentation, and basic credit concepts. Trainees also learn how to address common customer queries and clearly explain product benefits.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "This phase prepares trainees for real-world sales situations. They learn how to quickly understand customer needs, present EMI options effectively, handle objections, and cross-sell related products. It also introduces basic collection conversations and professional ways to manage delayed payments.",
    image: shikharImg,
  },
];
