...
const MODULES = [
  {
    ...
    description:
      "Develop strong fundamentals in banking, sales, and customer handling. Learn how to identify leads, understand customer needs, and communicate effectively while building the confidence required for a field sales role.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
      "Gain in-depth knowledge of loan products, processes, and cross-selling opportunities. Understand how to match the right product to the right customer and navigate real-world sales scenarios with clarity.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "Refine your sales approach to consistently meet targets and handle complex customer situations. Learn to manage relationships, drive conversions, and perform effectively in a fast-paced, target-driven environment.",
    image: shikharImg,
  },
];
