...
const MODULES = [
  {
    ...
    description:
      "Build a strong foundation in gold loan operations by learning customer acquisition, KYC and documentation, gold valuation basics, compliance requirements, and effective customer communication. Develop the skills needed to confidently handle day-to-day branch interactions.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
      "Apply your learning through practical sales and branch operations. Gain hands-on experience in processing loan applications, achieving business targets, managing customer relationships, handling renewals and collections, and delivering a seamless customer experience.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "Prepare for long-term career growth by strengthening your business acumen, leadership, and operational excellence. Learn to manage branch performance, drive customer retention, uphold compliance standards, and build the capabilities needed for higher operational and managerial roles.",
    image: shikharImg,
  },
];
...
export default function ClassroomTraining() {
  ...
  const dotPositions = [0, 33.7, 67.2];
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  backgroundColor: "rgba(228, 19, 37, 1)",
                }}
              />
                ...
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 items-stretch">
                  <div className="order-2 lg:order-1 flex-1 rounded-[10px] bg-black/20 px-4 sm:px-6 lg:px-8 py-6 lg:py-8 max-w-full lg:max-w-[512px]">
                    <div
                      ...
                      style={{
                        borderRadius: 100,
                        border: "1px solid rgba(228, 19, 37, 1)",
                        backgroundColor: "rgba(228, 19, 37, 1)",
                        paddingTop: 4,
                        paddingBottom: 4,
                        paddingLeft: 30,
                ...
                {index === MODULES.length - 1 && (
                  <div className="mt-6 sm:mt-8 flex justify-center sm:justify-start">
                    <button
                      ...
                      disabled
                      aria-disabled="true"
                      className="inline-flex items-center justify-center rounded-[10px] py-4 px-4 sm:px-6 bg-[#d9d9d9] text-[#8b8b8b] font-semibold text-sm border-0 cursor-not-allowed shadow-none"
                      style={{
                        fontFamily:
                          "Montserrat, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif",
                      }}
