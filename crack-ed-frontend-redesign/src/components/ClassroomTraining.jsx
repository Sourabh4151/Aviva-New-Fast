...
const MODULES = [
  {
    ...
    description:
      "Build your understanding of the insurance ecosystem, Aviva Life products, and agency roles. Develop professional grooming, communication skills, and the right sales mindset to confidently begin your journey.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
      "Gain clarity on Term, Savings, ULIPs, Retirement, and Child plans. Learn how to position products effectively and recommend the right solution based on customer needs.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "Master lead generation, need analysis, objection handling, and retention discipline. Turn conversations into conversions and build long-term customer relationships.",
    image: shikharImg,
  },
];
