...
const MODULES = [
  {
    ...
    description:
      "Build strong foundations in used car finance through hands-on exposure to dealer interactions, customer engagement, and on-ground sales execution. This phase helps you understand the basics of channel-driven lending, strengthen your communication skills, and build confidence in real market situations.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
      "Strengthen your understanding of vehicle financing products and credit-led decisioning while learning how to match the right financing solution to the right customer. This phase focuses on dealer relationship management, improving sales effectiveness, and driving better conversion through stronger product and process clarity.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "Excel in sales, service, and growth by taking ownership of dealer networks, driving business expansion, and delivering consistent performance. This phase prepares you to manage higher-value relationships, deepen channel partnerships, and contribute to scaling the used car finance business across markets.",
    image: shikharImg,
  },
];
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  backgroundColor: "rgba(87, 190, 136, 1)",
                }}
              />
                ...
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 items-stretch">
                  <div className="order-2 lg:order-1 flex-1 rounded-[10px] bg-black/20 px-4 sm:px-6 lg:px-8 py-6 lg:py-8 max-w-full lg:max-w-[512px]">
                    <div
                      ...
                      style={{
                        borderRadius: 100,
                        border: "1px solid rgba(87, 190, 136, 1)",
                        backgroundColor: "rgba(87, 190, 136, 1)",
                        paddingTop: 4,
                        paddingBottom: 4,
                        paddingLeft: 30,
