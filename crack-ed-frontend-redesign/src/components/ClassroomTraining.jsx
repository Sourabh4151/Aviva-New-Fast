...
const MODULES = [
  {
    ...
    description:
      "Build a strong foundation in the financial services industry with a focus on vehicle financing basics, customer interactions, and field sales essentials. This phase equips candidates with core knowledge, communication skills, and the confidence required to step into a customer-facing role.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    label: "Aarohan",
    heading: "Understanding Products & Processes",
    description:
      "Develop a deeper understanding of loan products, credit processes, and dealer ecosystems that drive the vehicle finance business. Candidates learn how to assess customer needs, explain financing options, and manage relationships with dealers and partners effectively.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    label: "Shikhar",
    heading: "Real-World Sales Execution",
    description:
      "Transition from learning to real-world readiness through practical, scenario-based training that mirrors on-ground challenges. This phase prepares candidates to handle customer conversations, documentation, and sales targets independently, enabling a smooth shift into full-time field roles.",
    image: shikharImg,
  },
];
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  backgroundColor: "rgba(223, 24, 54, 1)",
                }}
              />
                ...
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 items-stretch">
                  <div className="order-2 lg:order-1 flex-1 rounded-[10px] bg-black/20 px-4 sm:px-6 lg:px-8 py-6 lg:py-8 max-w-full lg:max-w-[512px]">
                    <div
                      ...
                      style={{
                        borderRadius: 100,
                        border: "1px solid rgba(223, 24, 54, 1)",
                        backgroundColor: "rgba(223, 24, 54, 1)",
                        paddingTop: 4,
                        paddingBottom: 4,
                        paddingLeft: 30,
