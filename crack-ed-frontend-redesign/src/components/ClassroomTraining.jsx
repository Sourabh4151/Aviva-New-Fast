...
const MODULES = [
  {
    ...
    description:
      "Build a solid understanding of the insurance ecosystem, Aviva Life’s product portfolio, and how agency roles operate in the real world. Strengthen your professional presence, sharpen your communication skills, and develop a confident, goal-oriented sales mindset, so you’re fully prepared to take your first step into the industry.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    label: "Aarohan",
    heading: "Product Knowledge That Converts",
    description:
      "Develop a clear understanding of Term, Savings, ULIPs, Retirement, and Child plans. Learn how to present each offering confidently and match the right solution to your customer’s specific needs and life goals.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "Build expertise in lead generation, effective need analysis, and confident objection handling. Strengthen your retention approach to convert conversations into meaningful outcomes, and nurture long-term customer relationships that drive sustained success.",
    image: shikharImg,
  },
];
              ...
              >
                ...
                {index === MODULES.length - 1 && (
                  <div className="mt-6 sm:mt-8 flex justify-center sm:justify-start">
                    <a
                      href="/FLS%20-%20Agency.pdf"
                      download="FLS - Agency.pdf"
