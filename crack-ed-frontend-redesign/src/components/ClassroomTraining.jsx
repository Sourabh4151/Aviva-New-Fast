...
const MODULES = [
  {
    ...
    description:
      "Build a solid grounding in two-wheeler finance by mastering the basics of customer interaction, showroom presence, and on-ground sales execution. This phase helps you understand how dealership networks operate, sharpens your communication and interpersonal skills, and builds the core confidence required to thrive in target-driven lending environments.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
      "Deepen your understanding of retail lending products, interest rates, and bank policies to match the right financing solution to the right customer. This phase focuses on the mechanics of credit and documentation—teaching you how to seamlessly verify KYC requirements, coordinate with operations teams, and submit error-free loan applications for quick approval.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "Accelerate your career by taking ownership of dealer portfolios, driving loan disbursement volumes, and delivering consistent sales performance. This phase prepares you to manage key channel relationships, maximize your application conversion ratios, and provide the high-quality customer service needed to scale the automotive finance business.",
    image: shikharImg,
  },
];
