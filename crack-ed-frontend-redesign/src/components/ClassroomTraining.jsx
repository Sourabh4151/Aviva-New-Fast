...
const MODULES = [
  {
    ...
    description:
      "Utthan focuses on building strong foundations for your journey in mortgage sales, introducing you to the housing finance industry, core products like home loans and LAP, and the basics of field sales. You’ll develop essential communication skills, understand customer interactions, and build the confidence needed to step into a client-facing role.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
      "Aarohan is centered on product mastery, helping you develop a deeper understanding of mortgage products, customer profiles, and sales strategies. You’ll learn how to match the right product to the right customer, handle objections effectively, and structure conversations that lead to successful conversions.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "Shikhar focuses on excelling in the role by sharpening your on-ground execution and performance mindset. You’ll learn how to manage pipelines, build strong partner networks, improve conversion rates, and consistently achieve targets, preparing you to stand out and grow quickly in a competitive sales environment.",
    image: shikharImg,
  },
];
