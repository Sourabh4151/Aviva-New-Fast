...
const MODULES = [
  {
    ...
    description:
      "Utthan focuses on understanding the housing finance collections ecosystem, repayment fundamentals, and customer communication basics. You’ll build confidence in field interactions, learn the essentials of portfolio health, and develop the professional discipline needed to begin customer-facing recovery work.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
      "Aarohan deepens your understanding of collection processes, customer behavior, and repayment resolution techniques. You’ll learn how to structure recovery conversations, handle objections professionally, document interactions accurately, and navigate real-world collection scenarios with greater confidence.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "Shikhar focuses on operational excellence and consistent field performance. You’ll learn how to manage assigned portfolios, prioritize visits, improve recovery effectiveness, coordinate with internal teams, and build the performance mindset required to grow from Collection Officer toward senior recovery and management roles.",
    image: shikharImg,
  },
];
