...
const MODULES = [
  {
    ...
    description:
      "Utthaan focuses on building the core skills needed to begin a career in rural banking and financial services. It introduces learners to field operations, customer engagement, and basic financial products while developing the confidence to interact with customers in real-world village environments.",
    image: uthaanImg,
  },
  {
    key: "aarohan",
    ...
    description:
      "In this phase, learners move into active field execution and begin handling customer sourcing and relationship management. It focuses on practical exposure to loan onboarding, group formation, and repayment support in rural markets.",
    image: aarohanImg,
  },
  {
    key: "shikhar",
    ...
    description:
      "Shikhar prepares learners for higher ownership in rural banking roles. It focuses on managing larger customer portfolios, driving business outcomes, and building readiness for leadership responsibilities in banking operations.",
    image: shikharImg,
  },
];
                ...
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 items-stretch">
                  <div className="order-2 lg:order-1 flex-1 rounded-[10px] bg-black/20 px-4 sm:px-6 lg:px-8 py-6 lg:py-8 max-w-full lg:max-w-[512px]">
                    <div
                      ...
                      style={{
                        borderRadius: 100,
                        border: "1px solid rgba(3, 149, 218, 1)",
                        backgroundColor: "rgba(3, 149, 218, 1)",
                        paddingTop: 4,
                        paddingBottom: 4,
                        paddingLeft: 30,
