...
const CARD_ACTIVE_BG = "rgba(9, 19, 14, 1)";
...
const LINE_ACTIVE_COLOR = "rgba(87, 190, 136, 1)";
          ...
          >
            <div className="w-full flex flex-col flex-1" style={{ gap: CARD_GAP }}>
              ...
              <div>
                ...
                >
                 You will be placed as a Business Manager upon successful completion of your classroom training.
                </p>
              </div>
