...
const CARD_ACTIVE_BG = "rgba(0, 15, 22, 1)";
...
const LINE_ACTIVE_COLOR = "rgba(3, 149, 218, 1)";
          ...
          >
            <div className="w-full flex flex-col flex-1" style={{ gap: CARD_GAP }}>
              ...
              <div>
                ...
                >
                 Get shortlisted for your interview, clear selection, and move into full-time employment post classroom training.
                </p>
              </div>
