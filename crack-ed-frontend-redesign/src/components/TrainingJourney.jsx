...
const CARD_ACTIVE_BG = "rgba(24, 3, 4, 1)";
...
const LINE_ACTIVE_COLOR = "rgba(228, 19, 37, 1)";
  ...
  return (
    ...
    >
      <div className="mx-auto px-section py-section lg:px-[120px] lg:pt-[110px] lg:pb-[110px]">
        ...
        >
          ...
          <article
            ...
            style={{
              ...
              minHeight: isMobile ? "auto" : CARD_MIN_HEIGHT,
              ...CARD_PADDING,
              gap: CARD_GAP,
            }}
          ...
          >
            <div className="w-full flex flex-col flex-1" style={{ gap: CARD_GAP }}>
              ...
              <div>
                ...
                >
                  Build strong role fundamentals through structured, instructor-led sessions focused on practical knowledge and real-world scenarios.
                </p>
              </div>
          ...
          >
            <div className="w-full flex flex-col flex-1" style={{ gap: CARD_GAP }}>
              ...
              <div>
                ...
                >
                 You will be placed as an Associate in the role of Gold Loan Relationship Officer upon successful completion of your classroom training.
                </p>
              </div>
        ...
        {/* Hidden: * Candidate will be subjected to review and performance appraisal
