...
const CARD_ACTIVE_BG = "rgba(21, 6, 7, 1)";
...
const LINE_ACTIVE_COLOR = "rgba(143, 40, 44, 0.3)";
          ...
          >
            <div className="w-full flex flex-col flex-1" style={{ gap: CARD_GAP }}>
              ...
              <div>
                ...
                >
                  After successful completion of the classroom training, candidates will appear for the final offline interview with a top bank.
                </p>
              </div>
